...
class Ui_SentencingDialog(object):
    def setupUi(self, SentencingDialog):
        ...
        self.jail_days = QtWidgets.QLineEdit(self.widget1)
        self.jail_days.setObjectName("jail_days")
        self.gridLayout.addWidget(self.jail_days, 1, 1, 1, 1)
        self.jail_days_suspended = QtWidgets.QLineEdit(self.widget1)
        ...
        SentencingDialog.setTabOrder(self.fines_suspended, self.pushButton)
