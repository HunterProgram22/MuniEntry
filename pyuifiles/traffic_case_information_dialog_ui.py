...
class Ui_TrafficCaseInformationDialog(object):
    def setupUi(self, TrafficCaseInformationDialog):
        ...
        TrafficCaseInformationDialog.setTabOrder(self.addOffenseButton, self.comboBox_2)
        TrafficCaseInformationDialog.setTabOrder(self.comboBox_2, self.plea_trial_date)
