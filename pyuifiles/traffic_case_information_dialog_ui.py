...
def create_charge_list():
    ...
    cursor = conn.cursor()
    cursor.execute("SELECT DISTINCT offense FROM charges")
    charge_list = cursor.fetchall()
    clean_charge_list = []
    for i in charge_list:
        clean_charge_list.append(i[0])
    print(clean_charge_list)
    conn.close()
    return clean_charge_list


class Ui_TrafficCaseInformationDialog(object):
    def setupUi(self, TrafficCaseInformationDialog):
        self.charge_list = create_charge_list()
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(11, 11, 931, 194))
        ...
        self.balance_due_date.setDateTime(QtCore.QDateTime.currentDateTime())
