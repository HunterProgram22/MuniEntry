...
class Ui_CaseInformationDialog(object):
    def setupUi(self, CaseInformationDialog):
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(20, 466, 931, 103))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(20, 332, 931, 103))
        ...
        self.widget.setGeometry(QtCore.QRect(23, 18, 701, 150))
        ...
        self.widget1.setGeometry(QtCore.QRect(20, 196, 411, 107))
        ...
        self.plea_trial_date = QtWidgets.QDateEdit(self.widget1)
        ...
        self.gridLayout_2.addWidget(self.plea_trial_date, 3, 1, 1, 1)
        ...
        self.continueButton_2.clicked.connect(CaseInformationDialog.ovi_dialog)
        self.continueButton.clicked.connect(CaseInformationDialog.sentencing_dialog)
        ...
        CaseInformationDialog.setTabOrder(self.comboBox, self.plea_trial_date)
