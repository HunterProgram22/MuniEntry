...
class Ui_CaseInformationDialog(object):
    def setupUi(self, CaseInformationDialog):
        ...
        self.violence_no_firearm_checkbox.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.citizen_deportation_checkbox_2.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.continueButton_2.setAutoDefault(False)
        ...
        self.waived_counsel_checkbox.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.understood_plea_checkbox = QtWidgets.QCheckBox(self.layoutWidget3)
        self.understood_plea_checkbox.setFocusPolicy(QtCore.Qt.NoFocus)
        self.understood_plea_checkbox.setChecked(True)
        self.understood_plea_checkbox.setObjectName("understood_plea_checkbox")
        self.gridLayout_2.addWidget(self.understood_plea_checkbox, 2, 2, 1, 1)
        ...
        CaseInformationDialog.setTabOrder(self.defendant_name, self.defendant_attorney_name)
        CaseInformationDialog.setTabOrder(self.defendant_attorney_name, self.plea_trial_date)
        CaseInformationDialog.setTabOrder(self.plea_trial_date, self.comboBox)
        ...
        CaseInformationDialog.setTabOrder(self.citizen_deportation_checkbox, self.continueButton_2)
        CaseInformationDialog.setTabOrder(self.continueButton_2, self.continueButton)
    ...
    def retranslateUi(self, CaseInformationDialog):
        ...
        self.understood_plea_checkbox.setText(_translate("CaseInformationDialog", "Defendant understood the charges and effects of plea per Crim.R. 11 / Traf.R. 10"))
