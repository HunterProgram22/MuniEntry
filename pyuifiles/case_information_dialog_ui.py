...
class Ui_CaseInformationDialog(object):
    def setupUi(self, CaseInformationDialog):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(870, 10, 118, 80))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(22, 17, 601, 189))
        ...
        self.defendant_attorney_name = QtWidgets.QLineEdit(self.layoutWidget1)
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(20, 360, 931, 103))
        ...
        self.layoutWidget_3 = QtWidgets.QWidget(CaseInformationDialog)
        self.layoutWidget_3.setGeometry(QtCore.QRect(20, 480, 271, 71))
        self.layoutWidget_3.setObjectName("layoutWidget_3")
        self.offense_of_violence_gridLayout_2 = QtWidgets.QGridLayout(self.layoutWidget_3)
        self.offense_of_violence_gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.offense_of_violence_gridLayout_2.setObjectName("offense_of_violence_gridLayout_2")
        self.comboBox = QtWidgets.QComboBox(self.layoutWidget_3)
        self.comboBox.setObjectName("comboBox")
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.offense_of_violence_gridLayout_2.addWidget(self.comboBox, 2, 0, 1, 1)
        ...
        self.offense_of_violence_gridLayout_2.addWidget(self.label_8, 1, 0, 1, 1)
        self.layoutWidget2 = QtWidgets.QWidget(CaseInformationDialog)
        self.layoutWidget2.setGeometry(QtCore.QRect(20, 230, 931, 103))
        self.layoutWidget2.setObjectName("layoutWidget2")
        self.citizenship_gridLayout = QtWidgets.QGridLayout(self.layoutWidget2)
        ...
        self.is_citizen_checkbox = QtWidgets.QCheckBox(self.layoutWidget2)
        ...
        self.citizen_deportation_checkbox = QtWidgets.QCheckBox(self.layoutWidget2)
        ...
        CaseInformationDialog.setTabOrder(self.plea_trial_date, self.is_citizen_checkbox)
        ...
        CaseInformationDialog.setTabOrder(self.citizen_deportation_checkbox_2, self.comboBox)
        CaseInformationDialog.setTabOrder(self.comboBox, self.continueButton)
