...
class Ui_SentencingDialog(object):
    def setupUi(self, SentencingDialog):
        ...
        self.gridLayout.addWidget(self.addOffenseButton, 5, 4, 1, 1)
        ...
        self.addOffenseButton.clicked.connect(SentencingDialog.add_offense)
        self.addOffenseButton.clicked.connect(self.offense_choice_box.clearEditText)
        self.addOffenseButton.clicked.connect(self.degree_choice_box.clearEditText)
        ...
        self.addOffenseButton.clicked.connect(self.jail_days.clear)
        self.addOffenseButton.clicked.connect(self.jail_days_suspended.clear)
        self.amendOffenseButton.clicked.connect(SentencingDialog.amend_offense)
    ...
    def retranslateUi(self, SentencingDialog):
        ...
        self.degree_choice_box.setItemText(1, _translate("SentencingDialog", "M1"))
        self.degree_choice_box.setItemText(2, _translate("SentencingDialog", "M2"))
        self.degree_choice_box.setItemText(3, _translate("SentencingDialog", "M3"))
        self.degree_choice_box.setItemText(4, _translate("SentencingDialog", "M4"))
        self.degree_choice_box.setItemText(5, _translate("SentencingDialog", "MM"))
        self.degree_choice_box.setItemText(6, _translate("SentencingDialog", "UCM"))
        self.finding_choice_box.setItemText(1, _translate("SentencingDialog", "Guilty"))
        self.finding_choice_box.setItemText(2, _translate("SentencingDialog", "Not Guilty"))
        self.finding_choice_box.setItemText(3, _translate("SentencingDialog", "Dismissed"))
        self.finding_choice_box.setItemText(4, _translate("SentencingDialog", "Dismissed with conditions"))
        ...
        self.plea_choice_box.setItemText(1, _translate("SentencingDialog", "Not Guilty"))
        self.plea_choice_box.setItemText(2, _translate("SentencingDialog", "No Contest"))
        self.plea_choice_box.setItemText(3, _translate("SentencingDialog", "Guilty"))
        self.plea_choice_box.setItemText(4, _translate("SentencingDialog", "No Plea - Dismissed"))
        self.pushButton_2.setText(_translate("SentencingDialog", "Clear Fields"))
        self.addOffenseButton.setText(_translate("SentencingDialog", "Add Another Offense"))
        self.deleteOffenseButton.setText(_translate("SentencingDialog", "Delete Offense"))
        self.amendOffenseButton.setText(_translate("SentencingDialog", "Amend Offense"))
