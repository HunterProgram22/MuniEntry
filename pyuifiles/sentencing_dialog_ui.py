...
class Ui_SentencingDialog(object):
    def setupUi(self, SentencingDialog):
        ...
        SentencingDialog.setTabOrder(self.pushButton_2, self.pushButton_4)
        SentencingDialog.setTabOrder(self.pushButton_4, self.pushButton_3)
        SentencingDialog.setTabOrder(self.pushButton_3, self.continueButton)
