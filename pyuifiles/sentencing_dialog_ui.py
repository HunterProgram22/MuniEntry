...
class Ui_SentencingDialog(object):
    def setupUi(self, SentencingDialog):
        ...
        SentencingDialog.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        ...
        self.frame.setGeometry(QtCore.QRect(9, 498, 982, 251))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.fines_1.setGeometry(QtCore.QRect(214, 112, 16, 27))
        self.fines_1.setText("")
        self.fines_1.setObjectName("fines_1")
        self.offense_label_1 = QtWidgets.QLabel(self.frame)
        self.offense_label_1.setGeometry(QtCore.QRect(13, 13, 77, 27))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_9.setGeometry(QtCore.QRect(13, 112, 53, 27))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.finding_2.setGeometry(QtCore.QRect(231, 79, 16, 27))
        self.finding_2.setText("")
        self.finding_2.setObjectName("finding_2")
        self.plea_label_1 = QtWidgets.QLabel(self.frame)
        self.plea_label_1.setGeometry(QtCore.QRect(13, 46, 42, 27))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.fines_suspended_2.setGeometry(QtCore.QRect(231, 145, 16, 27))
        ...
        self.finding_label_1.setGeometry(QtCore.QRect(13, 79, 75, 27))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.jail_days_suspended_1.setGeometry(QtCore.QRect(214, 211, 16, 27))
        ...
        self.label_11.setGeometry(QtCore.QRect(13, 178, 87, 27))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.plea_2.setGeometry(QtCore.QRect(231, 46, 16, 27))
        self.plea_2.setText("")
        ...
        self.jail_days_suspended_2.setGeometry(QtCore.QRect(231, 211, 16, 27))
        ...
        self.jail_days_suspended_3.setGeometry(QtCore.QRect(248, 211, 16, 27))
        ...
        self.fine_amount = QtWidgets.QLineEdit(self.layoutWidget)
        self.fine_amount.setObjectName("fine_amount")
        self.gridLayout.addWidget(self.fine_amount, 4, 1, 1, 1)
