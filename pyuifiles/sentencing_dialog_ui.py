...
class Ui_SentencingDialog(object):
    def setupUi(self, SentencingDialog):
        ...
        self.pushButton.clicked.connect(self.offense_choice_box.clearEditText)
        self.pushButton.clicked.connect(self.degree_choice_box.clearEditText)
        self.pushButton.clicked.connect(self.plea_choice_box.clearEditText)
        self.pushButton.clicked.connect(self.finding_choice_box.clearEditText)
        self.pushButton.clicked.connect(self.fines_amount.clear)
        self.pushButton.clicked.connect(self.fines_suspended.clear)
        self.pushButton.clicked.connect(self.jail_days.clear)
        self.pushButton.clicked.connect(self.jail_days_suspended.clear)
