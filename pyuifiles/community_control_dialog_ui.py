...
class Ui_CommunityControlDialog(object):
    def setupUi(self, CommunityControlDialog):
        ...
        self.term_of_community_control_box.addItem("")
        self.term_of_community_control_box.addItem("")
        self.gridLayout.addWidget(self.term_of_community_control_box, 1, 1, 1, 2)
        ...
        self.createEntryButton.clicked.connect(CommunityControlDialog.add_community_control)
        self.pushButton_2.clicked.connect(CommunityControlDialog.add_community_control)
        QtCore.QMetaObject.connectSlotsByName(CommunityControlDialog)
        CommunityControlDialog.setTabOrder(self.checkBox, self.term_of_community_control_box)
