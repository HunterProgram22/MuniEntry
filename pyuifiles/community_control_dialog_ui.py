...
class Ui_CommunityControlDialog(object):
    def setupUi(self, CommunityControlDialog):
        ...
        self.monitoredRadioButton = QtWidgets.QRadioButton(CommunityControlDialog)
        self.monitoredRadioButton.setGeometry(QtCore.QRect(603, 267, 122, 31))
        self.monitoredRadioButton.setObjectName("monitoredRadioButton")
        self.communityControlButtonGroup = QtWidgets.QButtonGroup(CommunityControlDialog)
        self.communityControlButtonGroup.setObjectName("communityControlButtonGroup")
        self.communityControlButtonGroup.addButton(self.monitoredRadioButton)
        self.intensiveRadioButton = QtWidgets.QRadioButton(CommunityControlDialog)
        self.intensiveRadioButton.setGeometry(QtCore.QRect(441, 267, 111, 31))
        self.intensiveRadioButton.setObjectName("intensiveRadioButton")
        self.communityControlButtonGroup.addButton(self.intensiveRadioButton)
        self.label_2 = QtWidgets.QLabel(CommunityControlDialog)
        self.label_2.setGeometry(QtCore.QRect(11, 228, 262, 27))
        self.label_2.setObjectName("label_2")
        self.community_control_required_checkbox = QtWidgets.QCheckBox(CommunityControlDialog)
        self.community_control_required_checkbox.setGeometry(QtCore.QRect(11, 191, 803, 31))
        self.community_control_required_checkbox.setObjectName("community_control_required_checkbox")
        self.term_of_community_control_box = QtWidgets.QComboBox(CommunityControlDialog)
        self.term_of_community_control_box.setGeometry(QtCore.QRect(279, 228, 124, 33))
        ...
        self.term_of_community_control_box.addItem("")
        self.term_of_community_control_box.addItem("")
        self.label_3 = QtWidgets.QLabel(CommunityControlDialog)
        self.label_3.setGeometry(QtCore.QRect(11, 267, 259, 27))
        self.label_3.setObjectName("label_3")
        self.checkBox_4 = QtWidgets.QCheckBox(CommunityControlDialog)
        self.checkBox_4.setGeometry(QtCore.QRect(11, 305, 327, 31))
        self.checkBox_4.setObjectName("checkBox_4")
        self.comboBox_2 = QtWidgets.QComboBox(CommunityControlDialog)
        self.comboBox_2.setEnabled(True)
        self.comboBox_2.setGeometry(QtCore.QRect(441, 304, 368, 33))
        ...
        self.comboBox_2.addItem("")
        self.comboBox_2.addItem("")
        self.checkBox_2 = QtWidgets.QCheckBox(CommunityControlDialog)
        self.checkBox_2.setGeometry(QtCore.QRect(11, 343, 482, 31))
        self.checkBox_2.setObjectName("checkBox_2")
        self.basicRadioButton = QtWidgets.QRadioButton(CommunityControlDialog)
        self.basicRadioButton.setEnabled(True)
        self.basicRadioButton.setGeometry(QtCore.QRect(279, 267, 73, 31))
        self.basicRadioButton.setChecked(True)
        self.basicRadioButton.setObjectName("basicRadioButton")
        self.communityControlButtonGroup.addButton(self.basicRadioButton)
    ...
    def retranslateUi(self, CommunityControlDialog):
        ...
        self.monitoredRadioButton.setText(_translate("CommunityControlDialog", "Monitored"))
        self.intensiveRadioButton.setText(_translate("CommunityControlDialog", "Intensive"))
        ...
        self.basicRadioButton.setText(_translate("CommunityControlDialog", "Basic"))
