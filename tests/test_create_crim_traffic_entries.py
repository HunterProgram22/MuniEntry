...
def test_jail_cc_plea_entry(qtbot, jcp_dialog):
    ...
    def add_conditions():
        ...
        mouse_click(jcp_dialog.popup_dialog.alcohol_monitoring_remove_checkBox)
...
def test_sentencing_only_entry(qtbot, sentencing_only_dialog):
    ...
    def add_conditions():
        ...
        mouse_click(sentencing_only_dialog.popup_dialog.alcohol_monitoring_remove_checkBox)
...
def test_trial_sentencing_entry(qtbot, trial_sentencing_dialog):
    ...
    def add_conditions():
        ...
        mouse_click(trial_sentencing_dialog.popup_dialog.alcohol_monitoring_remove_checkBox)
