...
@pytest.fixture
def jury_final_hearing_notice(qtbot, main_window):
    mouse_click(main_window.arraignments_radioButton)
    mouse_click(main_window.rohrer_radioButton)
    mouse_click(main_window.notice_of_hearingEntryButton)
    return main_window.dialog
...
def test_jury_final_hearing_notice_opens(qtbot, jury_final_hearing_notice):
    assert jury_final_hearing_notice.windowTitle() == "Notice Of Hearing Entry Rohrer Case Information"
