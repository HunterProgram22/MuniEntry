...
scheduling_dialog_buttons = [
    (
        ...
        'Final And Jury Notice Of Hearing Entry Case Information - Judge Marianne T. Hemmeter',
    ),
    (
        'rohrer_final_jury_hearingButton',
        'Final And Jury Notice Of Hearing Entry Case Information - Judge Kyle E. Rohrer',
    ),
    (
    ...
    (
        ...
        'Trial To Court Notice Of Hearing Entry Case Information - Judge Marianne T. Hemmeter',
    ),
    (
        'rohrer_trial_court_hearingButton',
        'Trial To Court Notice Of Hearing Entry Case Information - Judge Kyle E. Rohrer',
    ),
...
def test_dialogs_open_nocase_from_caselist(main_window, test_input, dialog_title):
