...
def test_continuance_calculator(hemmeter_gen_hearing_notice_dialog):
    ...
    hemmeter_gen_hearing_notice_dialog.old_speedy_trial_date.setDate(date)
    hemmeter_gen_hearing_notice_dialog.old_hearing_date.setDate(date_new)
    hemmeter_gen_hearing_notice_dialog.new_hearing_date.setDate(date)
    assert hemmeter_gen_hearing_notice_dialog.old_hearing_date.date().toString('MMMM dd, yyyy') == 'December 01, 2023'
