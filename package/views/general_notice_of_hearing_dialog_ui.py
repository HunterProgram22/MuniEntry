...
# Form implementation generated from reading ui file 'package/views/ui/GeneralNoticeOfHearingDialog.ui'
#
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, GeneralNoticeOfHearingDialog):
        ...
        self.label_5.setText(_translate("GeneralNoticeOfHearingDialog", "SCHEDULED DATES"))
        ...
        self.hearing_type_box.setItemText(1, _translate("GeneralNoticeOfHearingDialog", "Motion to Supress"))
        self.hearing_type_box.setItemText(2, _translate("GeneralNoticeOfHearingDialog", "Motion to Seal"))
