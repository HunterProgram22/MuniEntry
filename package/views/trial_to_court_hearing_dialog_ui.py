...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, TrialToCourtHearingDialog):
        ...
        self.trial_time_box.setItemText(0, _translate("TrialToCourtHearingDialog", "1:00 PM"))
        self.trial_time_box.setItemText(1, _translate("TrialToCourtHearingDialog", "1:15 PM"))
        self.trial_time_box.setItemText(2, _translate("TrialToCourtHearingDialog", "1:30 PM"))
        self.trial_time_box.setItemText(3, _translate("TrialToCourtHearingDialog", "1:45 PM"))
        self.trial_time_box.setItemText(4, _translate("TrialToCourtHearingDialog", "2:00 PM"))
        self.trial_time_box.setItemText(5, _translate("TrialToCourtHearingDialog", "2:15 PM"))
        self.trial_time_box.setItemText(6, _translate("TrialToCourtHearingDialog", "2:30 PM"))
        self.trial_time_box.setItemText(7, _translate("TrialToCourtHearingDialog", "2:45 PM"))
        self.trial_time_box.setItemText(8, _translate("TrialToCourtHearingDialog", "3:00 PM"))
        self.trial_time_box.setItemText(9, _translate("TrialToCourtHearingDialog", "3:15 PM"))
        self.trial_time_box.setItemText(10, _translate("TrialToCourtHearingDialog", "3:30 PM"))
        self.trial_time_box.setItemText(11, _translate("TrialToCourtHearingDialog", "3:45 PM"))
        self.trial_time_box.setItemText(12, _translate("TrialToCourtHearingDialog", "4:00 PM"))
        self.trial_time_box.setItemText(13, _translate("TrialToCourtHearingDialog", "4:15 PM"))
