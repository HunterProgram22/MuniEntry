...
"background-color: rgb(255, 255, 255);")
        ...
        self.courtroom_box = NoScrollComboBox(self.frame_5)
        self.courtroom_box.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.courtroom_box.setObjectName("courtroom_box")
        self.courtroom_box.addItem("")
        self.courtroom_box.addItem("")
        self.courtroom_box.addItem("")
        self.gridLayout_3.addWidget(self.courtroom_box, 3, 1, 1, 1)
...
"font-weight: bold;")
    ...
    def retranslateUi(self, TrialToCourtHearingDialog):
        ...
        self.trial_time_box.setItemText(0, _translate("TrialToCourtHearingDialog", "10:00 AM"))
        self.trial_time_box.setItemText(1, _translate("TrialToCourtHearingDialog", "10:30 AM"))
        self.trial_time_box.setItemText(2, _translate("TrialToCourtHearingDialog", "11:00 AM"))
        self.trial_time_box.setItemText(3, _translate("TrialToCourtHearingDialog", "11:30 AM"))
        self.trial_time_box.setItemText(4, _translate("TrialToCourtHearingDialog", "1:00 PM"))
        self.trial_time_box.setItemText(5, _translate("TrialToCourtHearingDialog", "1:30 PM"))
        self.trial_time_box.setItemText(6, _translate("TrialToCourtHearingDialog", "2:00 PM"))
        self.trial_time_box.setItemText(7, _translate("TrialToCourtHearingDialog", "2:30 PM"))
        self.trial_time_box.setItemText(8, _translate("TrialToCourtHearingDialog", "3:00 PM"))
        self.label_8.setText(_translate("TrialToCourtHearingDialog", "Assigned Courtroom:"))
        self.courtroom_box.setItemText(0, _translate("TrialToCourtHearingDialog", "Courtroom C"))
        self.courtroom_box.setItemText(1, _translate("TrialToCourtHearingDialog", "Courtroom B"))
        self.courtroom_box.setItemText(2, _translate("TrialToCourtHearingDialog", "Courtroom A"))
