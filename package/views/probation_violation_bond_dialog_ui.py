...
"font-weight: bold;")
        ...
        ProbationViolationBondDialog.setTabOrder(self.case_number_lineEdit, self.defense_counsel_name_box)
        ProbationViolationBondDialog.setTabOrder(self.defense_counsel_name_box, self.defense_counsel_type_box)
        ProbationViolationBondDialog.setTabOrder(self.defense_counsel_type_box, self.defense_counsel_waived_checkBox)
        ProbationViolationBondDialog.setTabOrder(self.defense_counsel_waived_checkBox, self.bond_type_box)
        ProbationViolationBondDialog.setTabOrder(self.bond_type_box, self.bond_amount_box)
        ProbationViolationBondDialog.setTabOrder(self.bond_amount_box, self.alcohol_drugs_assessment_checkBox)
        ProbationViolationBondDialog.setTabOrder(self.alcohol_drugs_assessment_checkBox, self.monitoring_checkBox)
        ProbationViolationBondDialog.setTabOrder(self.monitoring_checkBox, self.monitoring_type_box)
        ProbationViolationBondDialog.setTabOrder(self.monitoring_type_box, self.specialized_docket_checkBox)
        ProbationViolationBondDialog.setTabOrder(self.specialized_docket_checkBox, self.specialized_docket_type_box)
        ProbationViolationBondDialog.setTabOrder(self.specialized_docket_type_box, self.domestic_violence_checkBox)
        ProbationViolationBondDialog.setTabOrder(self.domestic_violence_checkBox, self.admin_license_suspension_checkBox)
        ProbationViolationBondDialog.setTabOrder(self.admin_license_suspension_checkBox, self.custodial_supervision_checkBox)
        ProbationViolationBondDialog.setTabOrder(self.custodial_supervision_checkBox, self.vehicle_seizure_checkBox)
        ProbationViolationBondDialog.setTabOrder(self.vehicle_seizure_checkBox, self.no_contact_checkBox)
        ProbationViolationBondDialog.setTabOrder(self.no_contact_checkBox, self.other_conditions_checkBox)
        ProbationViolationBondDialog.setTabOrder(self.other_conditions_checkBox, self.add_special_conditions_Button)
        ProbationViolationBondDialog.setTabOrder(self.add_special_conditions_Button, self.create_entry_Button)
    ...
    def retranslateUi(self, ProbationViolationBondDialog):
        ...
        self.vehicle_seizure_checkBox.setText(_translate("ProbationViolationBondDialog", "Vehicle Seizure / Immobilization"))
        self.admin_license_suspension_checkBox.setText(_translate("ProbationViolationBondDialog", "Administrative License Suspension"))
        self.label_10.setText(_translate("ProbationViolationBondDialog", "Special Conditions"))
        self.domestic_violence_checkBox.setText(_translate("ProbationViolationBondDialog", "Domestic Violence Restrictions"))
        self.custodial_supervision_checkBox.setText(_translate("ProbationViolationBondDialog", "Custodial Supervision"))
        self.no_contact_checkBox.setText(_translate("ProbationViolationBondDialog", "No Contact Restrictions"))
        self.other_conditions_checkBox.setText(_translate("ProbationViolationBondDialog", "Other Conditions"))
        self.add_special_conditions_Button.setText(_translate("ProbationViolationBondDialog", "Add Special Conditions"))
        ...
        self.appearance_reason_box.setItemText(0, _translate("ProbationViolationBondDialog", "arraignment"))
        self.appearance_reason_box.setItemText(1, _translate("ProbationViolationBondDialog", "motion hearing"))
        self.appearance_reason_box.setItemText(2, _translate("ProbationViolationBondDialog", "warrant for failure to appear"))
        ...
        self.alcohol_drugs_assessment_checkBox.setText(_translate("ProbationViolationBondDialog", " Obtain alcohol/drug assessment. "))
        ...
        self.specialized_docket_checkBox.setText(_translate("ProbationViolationBondDialog", "Screen for Specialized Dockets:"))
        self.label_7.setText(_translate("ProbationViolationBondDialog", "Bond Conditions"))
        self.specialized_docket_type_box.setItemText(0, _translate("ProbationViolationBondDialog", "OVI Docket"))
        self.specialized_docket_type_box.setItemText(1, _translate("ProbationViolationBondDialog", "Mission (Veteran\'s) Court"))
        self.specialized_docket_type_box.setItemText(2, _translate("ProbationViolationBondDialog", "Mental Health Docket"))
        ...
        self.mental_health_assessment_checkBox.setText(_translate("ProbationViolationBondDialog", " Obtain mental health assessment."))
        ...
        self.bond_amount_box.setItemText(0, _translate("ProbationViolationBondDialog", "None (OR Bond)"))
        ...
        self.bond_type_box.setItemText(0, _translate("ProbationViolationBondDialog", "Recognizance (OR) Bond"))
        self.bond_type_box.setItemText(1, _translate("ProbationViolationBondDialog", "10% Deposit, Cash or Surety Bond"))
        self.bond_type_box.setItemText(2, _translate("ProbationViolationBondDialog", "Cash or Surety Bond"))
