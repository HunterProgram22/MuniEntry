...
"font-weight: bold;")
        ...
        self.bond_conditions_frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
    ...
    def retranslateUi(self, ProbationViolationBondDialog):
        ...
        self.appearance_reason_box.setItemText(0, _translate("ProbationViolationBondDialog", "preliminary probation violation hearing"))
