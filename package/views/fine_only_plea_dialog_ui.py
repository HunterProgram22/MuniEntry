...
"")
        ...
        FineOnlyPleaDialog.setTabOrder(self.defense_counsel_waived_checkBox, self.court_costs_box)
    ...
    def retranslateUi(self, FineOnlyPleaDialog):
        ...
        self.court_costs_box.setItemText(2, _translate("FineOnlyPleaDialog", "No"))
        self.label_9.setText(_translate("FineOnlyPleaDialog", "Time to pay fines/costs:"))
        ...
        self.label_18.setText(_translate("FineOnlyPleaDialog", "Fines/costs due date:"))
        ...
        self.label_21.setText(_translate("FineOnlyPleaDialog", "FRA shown in complaint/file:"))
