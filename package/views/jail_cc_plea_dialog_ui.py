...
"font-weight: bold;")
        ...
        self.gridLayout_5.addWidget(self.add_conditions_Button, 8, 0, 1, 3)
        ...
        self.gridLayout_5.addWidget(self.victim_notification_checkBox, 5, 2, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.other_conditions_checkBox, 6, 2, 1, 1)
        ...
        JailCCPleaDialog.setTabOrder(self.community_service_checkBox, self.victim_notification_checkBox)
        JailCCPleaDialog.setTabOrder(self.victim_notification_checkBox, self.other_conditions_checkBox)
        JailCCPleaDialog.setTabOrder(self.other_conditions_checkBox, self.in_jail_box)
