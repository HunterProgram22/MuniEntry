...
"font-weight: bold;")
        ...
        JailCCPleaDialog.setTabOrder(self.fra_in_court_box, self.diversion_checkBox)
        JailCCPleaDialog.setTabOrder(self.diversion_checkBox, self.jail_checkBox)
        JailCCPleaDialog.setTabOrder(self.jail_checkBox, self.community_control_checkBox)
