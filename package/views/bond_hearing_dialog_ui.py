...
class Ui_BondHearingDialog(object):
    def setupUi(self, BondHearingDialog):
        ...
        BondHearingDialog.setWindowModality(QtCore.Qt.NonModal)
...
"font-weight: bold;")
        ...
        self.bond_frame.setFrameShape(QtWidgets.QFrame.Box)
        self.bond_frame.setFrameShadow(QtWidgets.QFrame.Plain)
        ...
        self.bond_amount_box = QtWidgets.QComboBox(self.bond_frame)
        font = QtGui.QFont()
        font.setFamily("Palatino Linotype")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.bond_type_box = QtWidgets.QComboBox(self.bond_frame)
...
"font-weight: bold;")
        ...
        self.bond_modification_decision_box = QtWidgets.QComboBox(self.case_name_Frame)
