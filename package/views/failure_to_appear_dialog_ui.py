...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_5.addWidget(self.set_bond_checkBox, 1, 0, 1, 2)
...
"font-weight: bold;")
    ...
    def retranslateUi(self, FailureToAppearDialog):
        ...
        self.appearance_reason_box.setItemText(1, _translate("FailureToAppearDialog", "final pre-trial"))
        self.appearance_reason_box.setItemText(2, _translate("FailureToAppearDialog", "LEAP sentencing"))
        self.appearance_reason_box.setItemText(3, _translate("FailureToAppearDialog", "jury trial"))
        self.appearance_reason_box.setItemText(4, _translate("FailureToAppearDialog", "trial to court"))
        self.appearance_reason_box.setItemText(5, _translate("FailureToAppearDialog", "motion hearing"))
        self.appearance_reason_box.setItemText(6, _translate("FailureToAppearDialog", "warrant for failure to appear"))
