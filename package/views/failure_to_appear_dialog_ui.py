...
"font-weight: bold;")
        ...
        self.failed_to_appear_checkBox = QtWidgets.QCheckBox(self.frame)
        self.failed_to_appear_checkBox.setObjectName("failed_to_appear_checkBox")
        self.gridLayout_3.addWidget(self.failed_to_appear_checkBox, 1, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.registration_block_checkBox, 5, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.non_resident_license_checkBox, 5, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.proof_of_service_checkBox, 6, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.set_no_trial_checkBox, 2, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.supplemental_summons_checkBox, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.operator_license_checkBox, 2, 1, 1, 1)
    ...
    def retranslateUi(self, FailureToAppearDialog):
        ...
        self.bond_type_box.setItemText(1, _translate("FailureToAppearDialog", "10% Deposit, Cash or Surety Bond"))
        self.bond_type_box.setItemText(2, _translate("FailureToAppearDialog", "Cash or Surety Bond"))
        self.bond_amount_box.setItemText(0, _translate("FailureToAppearDialog", "None (OR Bond)"))
        self.bond_amount_box.setItemText(1, _translate("FailureToAppearDialog", "$1,000"))
        ...
        self.failed_to_appear_checkBox.setText(_translate("FailureToAppearDialog", "Defendant failed to appear"))
