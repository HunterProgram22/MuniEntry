...
class Ui_NoJailPleaDialog(object):
    def setupUi(self, NoJailPleaDialog):
        ...
        NoJailPleaDialog.resize(1043, 809)
...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 1000, 818))
...
"font-weight: bold;")
        ...
        NoJailPleaDialog.setTabOrder(self.fra_in_court_box, self.credit_for_jail_checkBox)
        NoJailPleaDialog.setTabOrder(self.credit_for_jail_checkBox, self.jail_time_credit_box)
        NoJailPleaDialog.setTabOrder(self.jail_time_credit_box, self.license_suspension_checkBox)
