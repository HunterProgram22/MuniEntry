...
"background-color: rgb(255, 255, 255);")
        ...
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.gridLayout_5.addWidget(self.comboBox, 6, 1, 1, 1)
...
"font-weight: bold;")
    ...
    def retranslateUi(self, SchedulingEntryDialog):
        ...
        self.comboBox.setItemText(0, _translate("SchedulingEntryDialog", "1:00 PM"))
        self.comboBox.setItemText(1, _translate("SchedulingEntryDialog", "1:15 PM"))
        self.comboBox.setItemText(2, _translate("SchedulingEntryDialog", "1:30 PM"))
        self.comboBox.setItemText(3, _translate("SchedulingEntryDialog", "1:45 PM"))
        self.comboBox.setItemText(4, _translate("SchedulingEntryDialog", "2:00 PM"))
        self.comboBox.setItemText(5, _translate("SchedulingEntryDialog", "2:15 PM"))
        self.comboBox.setItemText(6, _translate("SchedulingEntryDialog", "2:30 PM"))
        self.comboBox.setItemText(7, _translate("SchedulingEntryDialog", "2:45 PM"))
        self.comboBox.setItemText(8, _translate("SchedulingEntryDialog", "3:00 PM"))
        self.comboBox.setItemText(9, _translate("SchedulingEntryDialog", "3:15 PM"))
        self.comboBox.setItemText(10, _translate("SchedulingEntryDialog", "3:30 PM"))
        self.comboBox.setItemText(11, _translate("SchedulingEntryDialog", "3:45 PM"))
        self.comboBox.setItemText(12, _translate("SchedulingEntryDialog", "4:00 PM"))
        self.comboBox.setItemText(13, _translate("SchedulingEntryDialog", "4:15 PM"))
