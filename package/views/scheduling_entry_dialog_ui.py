...
"background-color: rgb(255, 255, 255);")
        ...
        self.judge_hemmeter_radioButton = QtWidgets.QRadioButton(self.frame_5)
        self.judge_hemmeter_radioButton.setObjectName("judge_hemmeter_radioButton")
        self.gridLayout_5.addWidget(self.judge_hemmeter_radioButton, 1, 0, 1, 1)
        self.judge_rohrer_radioButton = QtWidgets.QRadioButton(self.frame_5)
        self.judge_rohrer_radioButton.setObjectName("judge_rohrer_radioButton")
        self.gridLayout_5.addWidget(self.judge_rohrer_radioButton, 1, 1, 1, 1)
        ...
        self.final_pretrial_time_box.addItem("")
        self.final_pretrial_time_box.addItem("")
        self.gridLayout_5.addWidget(self.final_pretrial_time_box, 6, 1, 1, 1)
...
"font-weight: bold;")
    ...
    def retranslateUi(self, SchedulingEntryDialog):
        ...
        self.label_15.setText(_translate("SchedulingEntryDialog", "Continuance Days"))
        self.judge_hemmeter_radioButton.setText(_translate("SchedulingEntryDialog", "Judge Hemmeter"))
        self.judge_rohrer_radioButton.setText(_translate("SchedulingEntryDialog", "Judge Rohrer"))
