...
class Ui_PleaOnlyDialog(object):
    def setupUi(self, PleaOnlyDialog):
        ...
        PleaOnlyDialog.resize(1045, 791)
...
"font-weight: bold;")
        ...
        self.gridLayout_6.addWidget(self.frame_8, 2, 1, 1, 1)
        ...
        PleaOnlyDialog.setTabOrder(self.case_number_lineEdit, self.create_entry_Button)
        PleaOnlyDialog.setTabOrder(self.create_entry_Button, self.close_dialog_Button)
