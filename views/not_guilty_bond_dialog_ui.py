...
class Ui_NotGuiltyBondDialog(object):
    def setupUi(self, NotGuiltyBondDialog):
        ...
        NotGuiltyBondDialog.resize(1012, 850)
...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 957, 813))
        ...
        self.gridLayout.addWidget(self.clear_fields_case_Button, 1, 5, 1, 1)
        self.label_5 = QtWidgets.QLabel(self.frame_3)
        self.label_5.setObjectName("label_5")
        self.gridLayout.addWidget(self.label_5, 2, 0, 1, 2)
        self.appearance_reason_box = QtWidgets.QComboBox(self.frame_3)
        ...
        self.appearance_reason_box.addItem("")
        self.gridLayout.addWidget(self.appearance_reason_box, 2, 2, 1, 4)
        ...
        self.no_contact_checkBox = QtWidgets.QCheckBox(self.frame_7)
        self.no_contact_checkBox.setObjectName("no_contact_checkBox")
        self.gridLayout_6.addWidget(self.no_contact_checkBox, 1, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.no_alcohol_drugs_checkBox, 2, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.alcohol_test_kiosk_checkBox, 4, 0, 1, 1)
        self.monitoring_checkBox = QtWidgets.QCheckBox(self.frame_7)
        self.monitoring_checkBox.setObjectName("monitoring_checkBox")
        self.gridLayout_6.addWidget(self.monitoring_checkBox, 7, 0, 1, 1)
        ...
        self.monitoring_type_box.addItem("")
        self.monitoring_type_box.addItem("")
        self.gridLayout_6.addWidget(self.monitoring_type_box, 7, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.alcohol_drugs_assessment_checkBox, 3, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.specialized_docket_checkBox, 5, 0, 1, 1)
        ...
        self.specialized_docket_type_box.addItem("")
        self.specialized_docket_type_box.addItem("")
        self.gridLayout_6.addWidget(self.specialized_docket_type_box, 5, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.frame_7, 4, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.create_entry_Button, 5, 0, 1, 1)
        ...
        NotGuiltyBondDialog.setTabOrder(self.add_charge_Button, self.scrollArea)
