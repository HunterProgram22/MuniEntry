...
"font-weight: bold;")
        ...
        self.defense_counsel_name = QtWidgets.QLineEdit(self.case_name_Frame)
        self.defense_counsel_name.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.defense_counsel_name.setObjectName("defense_counsel_name")
        self.gridLayout.addWidget(self.defense_counsel_name, 2, 1, 1, 1)
