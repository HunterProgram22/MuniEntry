...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1156, 852))
        ...
        AddSpecialBondConditionsDialog.setTabOrder(self.no_contact_name_box, self.other_conditions_plainTextEdit)
