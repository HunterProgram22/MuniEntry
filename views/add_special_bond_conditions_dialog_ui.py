...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 984, 936))
        ...
        self.gridLayout_7 = QtWidgets.QGridLayout(self.license_suspension_frame)
        ...
        self.license_type_box.addItem("")
        self.gridLayout_7.addWidget(self.license_type_box, 1, 1, 1, 1)
        ...
        self.term_of_suspension_box.addItem("")
        self.gridLayout_7.addWidget(self.term_of_suspension_box, 2, 1, 1, 1)
        self.label = QtWidgets.QLabel(self.license_suspension_frame)
        self.label.setObjectName("label")
        self.gridLayout_7.addWidget(self.label, 3, 0, 1, 1)
        self.textEdit = QtWidgets.QTextEdit(self.license_suspension_frame)
        ...
        self.gridLayout_7.addWidget(self.textEdit, 3, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.license_suspension_frame, 1, 0, 1, 2)
        ...
        self.gridLayout_11.addWidget(self.frame_4, 2, 0, 1, 2)
    ...
    def retranslateUi(self, AddSpecialBondConditionsDialog):
        ...
        self.license_type_box.setItemText(0, _translate("AddSpecialBondConditionsDialog", "No"))
        self.license_type_box.setItemText(1, _translate("AddSpecialBondConditionsDialog", "Yes"))
        self.label_21.setText(_translate("AddSpecialBondConditionsDialog", "Administrative License Suspension:"))
        self.term_of_suspension_box.setItemText(0, _translate("AddSpecialBondConditionsDialog", "Granted"))
        self.term_of_suspension_box.setItemText(1, _translate("AddSpecialBondConditionsDialog", "Denied"))
        ...
        self.checkBox_4.setText(_translate("AddSpecialBondConditionsDialog", "Vacate Residence located at:"))
