...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 984, 850))
        ...
        self.gridLayout_8.addWidget(self.vehicle_make_model_box, 1, 1, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.vehicle_license_plate_box, 2, 1, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.tow_to_residence_checkBox, 3, 0, 1, 2)
        ...
        AddSpecialBondConditionsDialog.setTabOrder(self.vehicle_license_plate_box, self.other_conditions_plainTextEdit)
