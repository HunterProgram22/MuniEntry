...
class Ui_TrafficCaseInformationDialog(object):
    def setupUi(self, TrafficCaseInformationDialog):
        ...
        self.addOffenseButton.setStyleSheet("background-color : darkGray")
        ...
        self.deleteOffenseButton.setStyleSheet("background-color : darkGray")
        self.gridLayout.addWidget(self.deleteOffenseButton, 2, 4, 1, 1)
        self.pushButton_4 = QtWidgets.QPushButton(self.layoutWidget)
        self.pushButton_4.setFocusPolicy(QtCore.Qt.NoFocus)
        self.pushButton_4.setObjectName("pushButton_4")
        self.pushButton_4.setStyleSheet("background-color : darkGray")
        ...
        self.pushButton_2.setStyleSheet("background-color : darkGray")
        ...
        self.createEntryButton.setStyleSheet("background-color : darkGray")
