...
class Ui_TrafficCaseInformationDialog(object):
    def setupUi(self, TrafficCaseInformationDialog):
        ...
        TrafficCaseInformationDialog.resize(1000, 905)
        ...
        TrafficCaseInformationDialog.setMinimumSize(QtCore.QSize(1000, 905))
...
"")
        ...
        self.frame.setGeometry(QtCore.QRect(10, 230, 981, 171))
...
"")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(12, 10, 451, 151))
        ...
        self.degree_choice_box.addItem("")
        self.degree_choice_box.addItem("")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.degree_choice_box)
        ...
        self.court_costs_box.addItem("")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.court_costs_box)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.statute_choice_box)
        self.layoutWidget1 = QtWidgets.QWidget(self.frame)
        self.layoutWidget1.setGeometry(QtCore.QRect(833, 10, 141, 156))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self.gridLayout = QtWidgets.QGridLayout(self.layoutWidget1)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.amendOffenseButton = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.addOffenseButton = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.deleteOffenseButton = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(470, 10, 349, 151))
        ...
        self.finding_choice_box.setMinimumSize(QtCore.QSize(192, 0))
        ...
        self.finding_choice_box.addItem("")
        self.finding_choice_box.addItem("")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.finding_choice_box)
        ...
        self.plea_choice_box.setMinimumSize(QtCore.QSize(192, 0))
        ...
        self.plea_choice_box.addItem("")
        self.plea_choice_box.addItem("")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.plea_choice_box)
        ...
        self.fines_amount = QtWidgets.QLineEdit(self.layoutWidget2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.fines_amount)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.fines_suspended)
        self.frame_2 = QtWidgets.QFrame(TrafficCaseInformationDialog)
        self.frame_2.setGeometry(QtCore.QRect(10, 410, 981, 301))
        font = QtGui.QFont()
        font.setFamily("Palatino Linotype")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(10, 10, 961, 281))
        ...
        self.frame_3.setGeometry(QtCore.QRect(10, 10, 981, 211))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"border-color: rgb(160, 48, 35);")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(833, 170, 139, 30))
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(10, 9, 791, 191))
        ...
        self.case_number = QtWidgets.QLineEdit(self.layoutWidget3)
        ...
        self.defendant_name = QtWidgets.QLineEdit(self.layoutWidget3)
        ...
        self.frame_4.setGeometry(QtCore.QRect(10, 715, 611, 91))
        ...
        self.createEntryButton.setGeometry(QtCore.QRect(790, 870, 201, 31))
...
"background-color: rgb(160, 160, 160);")
        ...
        self.frame_5.setGeometry(QtCore.QRect(10, 810, 611, 91))
        ...
        self.createEntryButton_2.setGeometry(QtCore.QRect(790, 720, 201, 31))
...
"background-color: rgb(160, 160, 160);")
        ...
        TrafficCaseInformationDialog.setTabOrder(self.offense_choice_box, self.finding_choice_box)
        TrafficCaseInformationDialog.setTabOrder(self.finding_choice_box, self.plea_choice_box)
        TrafficCaseInformationDialog.setTabOrder(self.plea_choice_box, self.fines_amount)
        ...
        TrafficCaseInformationDialog.setTabOrder(self.createEntryButton, self.createEntryButton_2)
