...
"border-color: rgb(160, 48, 35);")
        ...
        self.widget.setGeometry(QtCore.QRect(490, 13, 331, 100))
        ...
        self.operator_license_number_lineEdit = QtWidgets.QLineEdit(self.widget)
    ...
    def retranslateUi(self, MinorMisdemeanorDialog):
        ...
        self.addOffenseButton.setText(_translate("MinorMisdemeanorDialog", "Add Offense"))
