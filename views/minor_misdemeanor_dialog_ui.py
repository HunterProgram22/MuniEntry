...
"")
        ...
        self.addChargeButton = QtWidgets.QPushButton(self.layoutWidget)
        self.addChargeButton.setStyleSheet("background-color: rgb(160, 160, 160);")
        self.addChargeButton.setObjectName("addChargeButton")
        self.gridLayout.addWidget(self.addChargeButton, 4, 0, 1, 1)
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 10, 811, 81))
        ...
        self.gridLayout_3.addWidget(self.offense_choice_box, 0, 1, 1, 1)
...
"border-color: rgb(160, 48, 35);")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(835, 70, 141, 33))
        ...
        self.cancelButton.setGeometry(QtCore.QRect(835, 12, 141, 33))
        self.cancelButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.cancelButton.setStyleSheet("background-color: rgb(160, 160, 160);")
        self.cancelButton.setObjectName("cancelButton")
        self.layoutWidget3 = QtWidgets.QWidget(self.frame_3)
        self.layoutWidget3.setGeometry(QtCore.QRect(480, 11, 341, 96))
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(10, 10, 461, 98))
        ...
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.case_number_lineEdit)
        ...
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.defendant_first_name_lineEdit)
        ...
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.defendant_last_name_lineEdit)
        ...
        self.layoutWidget_3.setGeometry(QtCore.QRect(10, 10, 471, 64))
        ...
        self.createEntryButton = QtWidgets.QPushButton(MinorMisdemeanorDialog)
        self.createEntryButton.setGeometry(QtCore.QRect(810, 760, 181, 31))
        ...
        self.layoutWidget_4.setGeometry(QtCore.QRect(10, 10, 471, 64))
...
"font-weight: bold;")
        ...
        self.addConditionsButton = QtWidgets.QPushButton(MinorMisdemeanorDialog)
        self.addConditionsButton.setGeometry(QtCore.QRect(510, 760, 181, 31))
        self.addConditionsButton.setStyleSheet("background-color: rgb(157, 53, 36);")
        self.addConditionsButton.setAutoDefault(False)
        self.addConditionsButton.setObjectName("addConditionsButton")
        ...
        self.addChargeButton.clicked.connect(self.fines_suspended.clear)
        self.addChargeButton.clicked.connect(self.fines_amount.clear)
        self.pushButton_4.clicked.connect(self.fines_amount.clear)
        self.offense_choice_box.currentTextChanged['QString'].connect(MinorMisdemeanorDialog.set_statute)
        ...
        self.addChargeButton.clicked.connect(self.offense_choice_box.clearEditText)
        self.pushButton_4.clicked.connect(self.offense_choice_box.clearEditText)
        self.addChargeButton.clicked.connect(self.plea_choice_box.clearEditText)
        ...
        self.pushButton_2.clicked.connect(self.case_number_lineEdit.clear)
        self.fra_in_file_box.currentTextChanged['QString'].connect(MinorMisdemeanorDialog.set_fra_in_file)
        self.fra_in_court_box.currentTextChanged['QString'].connect(MinorMisdemeanorDialog.set_fra_in_court)
        self.amendOffenseButton.pressed.connect(MinorMisdemeanorDialog.update_case_information)
        self.addConditionsButton.clicked.connect(MinorMisdemeanorDialog.start_add_conditions_dialog)
        self.amendOffenseButton.clicked.connect(MinorMisdemeanorDialog.start_amend_offense_dialog)
        self.statute_choice_box.currentTextChanged['QString'].connect(MinorMisdemeanorDialog.set_offense)
        self.pushButton_2.clicked.connect(self.defendant_last_name_lineEdit.clear)
        QtCore.QMetaObject.connectSlotsByName(MinorMisdemeanorDialog)
        MinorMisdemeanorDialog.setTabOrder(self.case_number_lineEdit, self.defendant_first_name_lineEdit)
        MinorMisdemeanorDialog.setTabOrder(self.defendant_first_name_lineEdit, self.defendant_last_name_lineEdit)
        MinorMisdemeanorDialog.setTabOrder(self.defendant_last_name_lineEdit, self.operator_license_number_lineEdit)
        MinorMisdemeanorDialog.setTabOrder(self.operator_license_number_lineEdit, self.defendant_birth_date)
        MinorMisdemeanorDialog.setTabOrder(self.defendant_birth_date, self.freeform_entry_checkBox)
        MinorMisdemeanorDialog.setTabOrder(self.freeform_entry_checkBox, self.offense_choice_box)
        MinorMisdemeanorDialog.setTabOrder(self.offense_choice_box, self.statute_choice_box)
        MinorMisdemeanorDialog.setTabOrder(self.statute_choice_box, self.plea_choice_box)
        ...
        MinorMisdemeanorDialog.setTabOrder(self.court_costs_box, self.addChargeButton)
        MinorMisdemeanorDialog.setTabOrder(self.addChargeButton, self.ability_to_pay_box)
        ...
        MinorMisdemeanorDialog.setTabOrder(self.community_service_checkBox, self.checkBox_3)
        MinorMisdemeanorDialog.setTabOrder(self.checkBox_3, self.checkBox_7)
        MinorMisdemeanorDialog.setTabOrder(self.checkBox_7, self.checkBox_4)
        MinorMisdemeanorDialog.setTabOrder(self.checkBox_4, self.checkBox_5)
        MinorMisdemeanorDialog.setTabOrder(self.checkBox_5, self.community_control_checkBox)
        MinorMisdemeanorDialog.setTabOrder(self.community_control_checkBox, self.checkBox_8)
        MinorMisdemeanorDialog.setTabOrder(self.checkBox_8, self.addConditionsButton)
        MinorMisdemeanorDialog.setTabOrder(self.addConditionsButton, self.createEntryButton)
    ...
    def retranslateUi(self, MinorMisdemeanorDialog):
        ...
        self.addChargeButton.setText(_translate("MinorMisdemeanorDialog", "Add Charge"))
        self.amendOffenseButton.setText(_translate("MinorMisdemeanorDialog", "Amend Offense"))
        self.pushButton_4.setText(_translate("MinorMisdemeanorDialog", "Clear Fields"))
        ...
        self.court_costs_box.setItemText(0, _translate("MinorMisdemeanorDialog", "No"))
        self.court_costs_box.setItemText(1, _translate("MinorMisdemeanorDialog", "Yes"))
        ...
        self.pushButton_2.setText(_translate("MinorMisdemeanorDialog", "Clear Fields"))
        self.cancelButton.setText(_translate("MinorMisdemeanorDialog", "Cancel"))
        ...
        self.createEntryButton.setText(_translate("MinorMisdemeanorDialog", "Create Entry"))
        ...
        self.addConditionsButton.setText(_translate("MinorMisdemeanorDialog", "Add Conditions"))
