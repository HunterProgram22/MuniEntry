...
"font-weight: bold;")
        ...
        self.add_charge_Button.pressed.connect(self.finding_choice_box.clearEditText)
        self.add_charge_Button.pressed.connect(self.fines_suspended.clear)
        self.add_charge_Button.pressed.connect(self.fines_amount.clear)
        ...
        self.add_charge_Button.pressed.connect(self.offense_choice_box.clearEditText)
        self.clear_fields_charge_Button.pressed.connect(self.offense_choice_box.clearEditText)
        self.add_charge_Button.pressed.connect(self.plea_choice_box.clearEditText)
        self.clear_fields_charge_Button.pressed.connect(self.fines_suspended.clear)
        self.add_charge_Button.pressed.connect(self.statute_choice_box.clearEditText)
        ...
        MinorMisdemeanorDialog.setTabOrder(self.checkBox_7, self.add_conditions_Button)
        MinorMisdemeanorDialog.setTabOrder(self.add_conditions_Button, self.create_entry_Button)
        MinorMisdemeanorDialog.setTabOrder(self.create_entry_Button, self.checkBox_4)
