...
"font-weight: bold;")
        ...
        MinorMisdemeanorDialog.setTabOrder(self.defendant_last_name_lineEdit, self.offense_choice_box)
        ...
        MinorMisdemeanorDialog.setTabOrder(self.community_control_checkBox, self.checkBox_7)
        MinorMisdemeanorDialog.setTabOrder(self.checkBox_7, self.addConditionsButton)
        MinorMisdemeanorDialog.setTabOrder(self.addConditionsButton, self.createEntryButton)
        MinorMisdemeanorDialog.setTabOrder(self.createEntryButton, self.checkBox_4)
        MinorMisdemeanorDialog.setTabOrder(self.checkBox_4, self.checkBox_5)
        MinorMisdemeanorDialog.setTabOrder(self.checkBox_5, self.checkBox_3)
        MinorMisdemeanorDialog.setTabOrder(self.checkBox_3, self.checkBox_8)
        MinorMisdemeanorDialog.setTabOrder(self.checkBox_8, self.operator_license_number_lineEdit)
