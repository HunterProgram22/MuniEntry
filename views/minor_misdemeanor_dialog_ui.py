...
"border-color: rgb(160, 48, 35);")
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(10, 40, 461, 121))
        ...
        self.addOffenseButton.pressed.connect(MinorMisdemeanorDialog.add_offense)
        ...
        MinorMisdemeanorDialog.setTabOrder(self.fines_suspended, self.addOffenseButton)
        MinorMisdemeanorDialog.setTabOrder(self.addOffenseButton, self.ability_to_pay_box)
    ...
    def retranslateUi(self, MinorMisdemeanorDialog):
        ...
        self.addOffenseButton.setText(_translate("MinorMisdemeanorDialog", "Add Charge"))
