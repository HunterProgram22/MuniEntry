...
"font-weight: bold;")
        ...
        self.limited_driving_privilegesButton = QtWidgets.QPushButton(self.scheduling_Tab)
        self.limited_driving_privilegesButton.setStyleSheet("background-color: rgb(160, 160, 160);")
        self.limited_driving_privilegesButton.setObjectName("limited_driving_privilegesButton")
        self.gridLayout_4.addWidget(self.limited_driving_privilegesButton, 0, 1, 1, 1)
