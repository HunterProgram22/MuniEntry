...
"font-weight: bold;")
        ...
        self.LeapAdmissionValidButton = QtWidgets.QPushButton(self.crimTab)
        ...
        self.judicial_officer_frame = QtWidgets.QFrame(self.crimTab)
        ...
        self.gridLayout_2.addWidget(self.judicial_officer_frame, 0, 0, 1, 3)
        ...
        self.label = QtWidgets.QLabel(self.schedulingTab)
        self.label.setObjectName("label")
        self.gridLayout_4.addWidget(self.label, 0, 0, 1, 1)
        self.radioButton = QtWidgets.QRadioButton(self.schedulingTab)
        self.radioButton.setObjectName("radioButton")
        self.gridLayout_4.addWidget(self.radioButton, 0, 1, 1, 1)
        self.radioButton_2 = QtWidgets.QRadioButton(self.schedulingTab)
        self.radioButton_2.setObjectName("radioButton_2")
        self.gridLayout_4.addWidget(self.radioButton_2, 0, 2, 1, 1)
        self.line = QtWidgets.QFrame(self.schedulingTab)
        ...
        self.gridLayout_4.addWidget(self.hemmeter_schedulingEntryButton, 2, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.rohrer_schedulingEntryButton, 2, 2, 1, 1)
        self.final_jury_hearingEntryButton_2 = QtWidgets.QPushButton(self.schedulingTab)
        self.final_jury_hearingEntryButton_2.setMinimumSize(QtCore.QSize(120, 30))
        self.final_jury_hearingEntryButton_2.setStyleSheet("background-color: rgb(85, 170, 255);")
        self.final_jury_hearingEntryButton_2.setObjectName("final_jury_hearingEntryButton_2")
        self.gridLayout_4.addWidget(self.final_jury_hearingEntryButton_2, 3, 0, 1, 1)
        self.final_jury_hearingEntryButton = QtWidgets.QPushButton(self.schedulingTab)
        self.final_jury_hearingEntryButton.setMinimumSize(QtCore.QSize(120, 30))
        self.final_jury_hearingEntryButton.setStyleSheet("background-color: rgb(85, 170, 255);")
        self.final_jury_hearingEntryButton.setObjectName("final_jury_hearingEntryButton")
        self.gridLayout_4.addWidget(self.final_jury_hearingEntryButton, 3, 2, 1, 1)
        self.general_hearingEntryButton = QtWidgets.QPushButton(self.schedulingTab)
        self.general_hearingEntryButton.setMinimumSize(QtCore.QSize(120, 30))
        self.general_hearingEntryButton.setStyleSheet("background-color: rgb(85, 170, 255);")
        self.general_hearingEntryButton.setObjectName("general_hearingEntryButton")
        self.gridLayout_4.addWidget(self.general_hearingEntryButton, 4, 0, 1, 1)
        self.general_hearingEntryButton_2 = QtWidgets.QPushButton(self.schedulingTab)
        self.general_hearingEntryButton_2.setMinimumSize(QtCore.QSize(120, 30))
        self.general_hearingEntryButton_2.setStyleSheet("background-color: rgb(85, 170, 255);")
        self.general_hearingEntryButton_2.setObjectName("general_hearingEntryButton_2")
        self.gridLayout_4.addWidget(self.general_hearingEntryButton_2, 4, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.random_judge_Button, 6, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.assign_judge_label, 6, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.last_judge_assigned_label, 6, 2, 1, 1)
        self.tabWidget.addTab(self.schedulingTab, "")
        self.gridLayout_5.addWidget(self.tabWidget, 0, 0, 2, 1)
        ...
        self.pleas_cases_box.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.trials_to_court_cases_box.setMinimumSize(QtCore.QSize(0, 40))
        ...
        self.pcvh_fcvh_cases_box.setMinimumSize(QtCore.QSize(0, 40))
        ...
        self.arraignments_cases_box.setMinimumSize(QtCore.QSize(0, 40))
...
"selection-background-color: rgb(85, 170, 255);")
        ...
        self.slated_cases_box.setMinimumSize(QtCore.QSize(0, 40))
        ...
        self.final_pretrial_cases_box.setMinimumSize(QtCore.QSize(0, 40))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton.setText(_translate("MainWindow", "Pat Dattilo"))
        self.radioButton_2.setText(_translate("MainWindow", "Kathryn Patterson"))
        ...
        self.final_jury_hearingEntryButton_2.setText(_translate("MainWindow", "Hemmeter - Final/Jury Notice of Hearing"))
        self.final_jury_hearingEntryButton.setText(_translate("MainWindow", "Rohrer - Final/Jury Notice of Hearing"))
        self.general_hearingEntryButton.setText(_translate("MainWindow", "Hemmeter - General Notice of Hearing"))
        self.general_hearingEntryButton_2.setText(_translate("MainWindow", "Rohrer - General Notice of Hearing"))
