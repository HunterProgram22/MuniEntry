...
"font-weight: bold;")
        ...
        self.gridLayout_21 = QtWidgets.QGridLayout(self.mattox_tab)
        ...
        self.count_scram_gps_label = QtWidgets.QLabel(self.mattox_tab)
        self.count_scram_gps_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.count_scram_gps_label.setObjectName("count_scram_gps_label")
        self.gridLayout_20.addWidget(self.count_scram_gps_label, 1, 0, 1, 1)
        self.count_comm_control_label = QtWidgets.QLabel(self.mattox_tab)
        self.count_comm_control_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.count_comm_control_label.setObjectName("count_comm_control_label")
        self.gridLayout_20.addWidget(self.count_comm_control_label, 2, 0, 1, 1)
        self.probation_workflowButton = QtWidgets.QPushButton(self.mattox_tab)
        ...
        self.gridLayout_20.addWidget(self.probation_workflowButton, 3, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_20.setText(_translate("MainWindow", "Probation Pending Entries"))
        self.count_scram_gps_label.setText(_translate("MainWindow", "Count_SCRAM_GPS"))
        self.count_comm_control_label.setText(_translate("MainWindow", "Count_Comm_Control"))
        self.probation_workflowButton.setText(_translate("MainWindow", "Open Probation Workflow"))
        self.workflows_person_tab.setTabText(self.workflows_person_tab.indexOf(self.mattox_tab), _translate("MainWindow", "Prob - Mattox"))
