...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1031, 816))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_6.addWidget(self.speedy_trial_date_label, 10, 1, 1, 2)
        self.no_in_jail_radio_btn = QtWidgets.QRadioButton(self.frame_6)
        self.no_in_jail_radio_btn.setChecked(True)
        self.no_in_jail_radio_btn.setObjectName("no_in_jail_radio_btn")
        self.gridLayout_6.addWidget(self.no_in_jail_radio_btn, 6, 1, 1, 1)
        ...
        self.highest_charge_box.addItem("")
        self.highest_charge_box.addItem("")
        self.gridLayout_6.addWidget(self.highest_charge_box, 2, 1, 1, 2)
        self.yes_in_jail_radio_btn = QtWidgets.QRadioButton(self.frame_6)
        self.yes_in_jail_radio_btn.setObjectName("yes_in_jail_radio_btn")
        self.gridLayout_6.addWidget(self.yes_in_jail_radio_btn, 6, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.days_in_jail_line, 7, 1, 1, 2)
        ...
        self.gridLayout_6.addWidget(self.continuance_days_line, 8, 1, 1, 2)
        ...
        self.days_in_jail_label = QtWidgets.QLabel(self.frame_6)
        self.days_in_jail_label.setObjectName("days_in_jail_label")
        self.gridLayout_6.addWidget(self.days_in_jail_label, 7, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.label_17, 4, 0, 1, 3)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_5.addWidget(self.trial_date, 10, 1, 1, 1)
        self.four_week_pretrial_radio_btn = QtWidgets.QRadioButton(self.frame_5)
        self.four_week_pretrial_radio_btn.setChecked(False)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_5.addWidget(self.pretrial_date, 7, 1, 1, 1)
        ...
        self.final_pretrial_time.addItem("")
        self.final_pretrial_time.addItem("")
        self.gridLayout_5.addWidget(self.final_pretrial_time, 9, 1, 1, 1)
        ...
        self.no_pretrial_radio_btn.setChecked(True)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_5.addWidget(self.final_pretrial_date, 8, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.pretrial_date_label, 7, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.dates_confirmed_check_box, 6, 0, 1, 1)
...
"font-weight: bold;")
    ...
    def retranslateUi(self, SchedulingEntryDialog):
        ...
        self.label_8.setText(_translate("SchedulingEntryDialog", "Defendant in Jail:"))
        self.speedy_trial_date_label.setText(_translate("SchedulingEntryDialog", "Speedy Trial Date"))
        self.no_in_jail_radio_btn.setText(_translate("SchedulingEntryDialog", "No"))
        ...
        self.highest_charge_box.setItemText(6, _translate("SchedulingEntryDialog", "UCM - 3rd OVI"))
        self.yes_in_jail_radio_btn.setText(_translate("SchedulingEntryDialog", "Yes"))
        ...
        self.label_18.setText(_translate("SchedulingEntryDialog", " If a Cash, Surety or 10% Bond is set, then select Yes for Defendant in Jail and speedy trial time will be set at 1/3 of time (example 30 days for an M1 instead of 90)."))
        ...
        self.dates_confirmed_check_box.setText(_translate("SchedulingEntryDialog", "Dates Confirmed with Counsel"))
