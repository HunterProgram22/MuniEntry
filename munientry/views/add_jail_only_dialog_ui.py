# Form implementation generated from reading ui file 'munientry/views/ui/AddJailOnlyDialog.ui'
#
...
class Ui_AddJailOnly(object):
    def setupUi(self, AddJailOnly):
        ...
        AddJailOnly.setWindowModality(QtCore.Qt.WindowModality.NonModal)
...
"font-weight: bold;")
        ...
        self.jail_commitment_frame.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.jail_commitment_frame.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
