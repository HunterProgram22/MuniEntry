...
"background-color: rgb(255, 255, 255);")
        ...
        self.permanent_id_check_box = QtWidgets.QCheckBox(self.frame)
        self.permanent_id_check_box.setObjectName("permanent_id_check_box")
        self.gridLayout_3.addWidget(self.permanent_id_check_box, 9, 0, 1, 1)
        ...
        self.out_of_state_license_check_box = QtWidgets.QCheckBox(self.frame)
        self.out_of_state_license_check_box.setObjectName("out_of_state_license_check_box")
        self.gridLayout_3.addWidget(self.out_of_state_license_check_box, 5, 0, 1, 1)
        ...
        self.license_exp_date_label = QtWidgets.QLabel(self.frame)
        self.license_exp_date_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.license_exp_date_label.setObjectName("license_exp_date_label")
        self.gridLayout_3.addWidget(self.license_exp_date_label, 10, 0, 1, 1)
        ...
        self.license_exp_date_field = NoScrollDateEdit(self.frame)
        self.license_exp_date_field.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.license_exp_date_field.setCalendarPopup(True)
        self.license_exp_date_field.setObjectName("license_exp_date_field")
        self.gridLayout_3.addWidget(self.license_exp_date_field, 11, 0, 1, 1)
        self.line_2 = QtWidgets.QFrame(self.frame)
        self.line_2.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_2.setObjectName("line_2")
        self.gridLayout_3.addWidget(self.line_2, 12, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.no_jurisdiction_check_box, 5, 1, 1, 1)
        self.no_pay_plan_check_box = QtWidgets.QCheckBox(self.frame)
        self.no_pay_plan_check_box.setObjectName("no_pay_plan_check_box")
        self.gridLayout_3.addWidget(self.no_pay_plan_check_box, 2, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.permit_test_radio_btn, 8, 0, 1, 1)
        self.terminate_radio_btn = QtWidgets.QRadioButton(self.frame)
        self.terminate_radio_btn.setObjectName("terminate_radio_btn")
        self.gridLayout_3.addWidget(self.terminate_radio_btn, 15, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.permit_renew_radio_btn, 13, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_3, 14, 0, 1, 2)
        self.privileges_grant_label = QtWidgets.QLabel(self.frame)
        self.privileges_grant_label.setObjectName("privileges_grant_label")
        self.gridLayout_3.addWidget(self.privileges_grant_label, 16, 0, 1, 1)
...
"color: rgb(0, 0, 0);")
        ...
        self.nufc_date_label = QtWidgets.QLabel(self.frame)
        self.nufc_date_label.setObjectName("nufc_date_label")
        self.gridLayout_3.addWidget(self.nufc_date_label, 17, 0, 1, 1)
    ...
    def retranslateUi(self, DenyPrivilegesDialog):
        ...
        self.permanent_id_check_box.setText(_translate("DenyPrivilegesDialog", "Check if defendant has permanent ID card instead of expired license"))
        self.label_4.setText(_translate("DenyPrivilegesDialog", "DRIVING PRIVILEGES ENTRY TYPE"))
        self.out_of_state_license_check_box.setText(_translate("DenyPrivilegesDialog", "Out of State License - Needs Certified Abstract"))
        ...
        self.license_exp_date_label.setText(_translate("DenyPrivilegesDialog", "Defendant Driver License Expiration Date:"))
        ...
        self.no_pay_plan_check_box.setText(_translate("DenyPrivilegesDialog", "Defendant not on or current with fines and costs pay plan"))
        ...
        self.terminate_radio_btn.setText(_translate("DenyPrivilegesDialog", "Terminate Privileges - Fail to Pay"))
        ...
        self.privileges_grant_label.setText(_translate("DenyPrivilegesDialog", "Date Privileges were Granted on:"))
        self.nufc_date_label.setText(_translate("DenyPrivilegesDialog", "Notice of Unpaid Fines and Costs (NUFC) Letter Date:"))
