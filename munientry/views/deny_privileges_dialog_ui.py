...
"font-weight: bold;")
        ...
        self.prohibited_actitivies_check_box = QtWidgets.QCheckBox(self.frame)
        self.prohibited_actitivies_check_box.setObjectName("prohibited_actitivies_check_box")
        self.gridLayout_3.addWidget(self.prohibited_actitivies_check_box, 4, 1, 1, 1)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, DenyPrivilegesDialog):
        ...
        self.prohibited_actitivies_check_box.setText(_translate("DenyPrivilegesDialog", "Petition requests privileges for activities not permitted by this Court"))
