...
"font-weight: bold;")
        ...
        self.old_speedy_trial_dateEdit = NoScrollDateEdit(self.frame_6)
        self.old_speedy_trial_dateEdit.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(255, 255, 255);")
        self.old_speedy_trial_dateEdit.setCalendarPopup(True)
        self.old_speedy_trial_dateEdit.setObjectName("old_speedy_trial_dateEdit")
        self.gridLayout_7.addWidget(self.old_speedy_trial_dateEdit, 2, 1, 1, 1)
