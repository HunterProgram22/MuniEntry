...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1230, 861))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.final_pretrial_time_box.addItem("")
        self.final_pretrial_time_box.addItem("")
        self.gridLayout_3.addWidget(self.final_pretrial_time_box, 9, 1, 1, 2)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_3.addWidget(self.trial_date, 10, 1, 1, 2)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_3.addWidget(self.final_pretrial_date, 8, 1, 1, 2)
        ...
        self.hearing_location_box.addItem("")
        self.hearing_location_box.addItem("")
        self.gridLayout_3.addWidget(self.hearing_location_box, 11, 1, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.language_box, 2, 1, 1, 2)
        self.instructions_label = QtWidgets.QLabel(self.frame_5)
        self.instructions_label.setObjectName("instructions_label")
        self.gridLayout_3.addWidget(self.instructions_label, 1, 0, 1, 3)
        ...
        self.gridLayout_3.addWidget(self.jury_trial_only_yes_radio_btn, 4, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.final_pretrial_time_label, 9, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.final_pretrial_date_label, 8, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.interpreter_check_box, 2, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.jury_trial_only_no_radio_btn, 4, 2, 1, 1)
        self.dates_confirmed_check_box = QtWidgets.QCheckBox(self.frame_5)
        self.dates_confirmed_check_box.setObjectName("dates_confirmed_check_box")
        self.gridLayout_3.addWidget(self.dates_confirmed_check_box, 3, 0, 1, 1)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, FinalJuryNoticeOfHearingDialog):
        ...
        self.language_box.setPlaceholderText(_translate("FinalJuryNoticeOfHearingDialog", "Language Required"))
        ...
        self.interpreter_check_box.setText(_translate("FinalJuryNoticeOfHearingDialog", "Interpreter Required"))
        ...
        self.dates_confirmed_check_box.setText(_translate("FinalJuryNoticeOfHearingDialog", "Dates were Confirmed with Counsel"))
