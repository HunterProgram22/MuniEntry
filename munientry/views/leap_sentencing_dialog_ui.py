...
class Ui_LeapSentencingDialog(object):
    def setupUi(self, LeapSentencingDialog):
        LeapSentencingDialog.setObjectName("LeapSentencingDialog")
        LeapSentencingDialog.setWindowModality(QtCore.Qt.WindowModality.NonModal)
        LeapSentencingDialog.setEnabled(True)
        LeapSentencingDialog.resize(1020, 722)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(LeapSentencingDialog.sizePolicy().hasHeightForWidth())
        LeapSentencingDialog.setSizePolicy(sizePolicy)
        LeapSentencingDialog.setMinimumSize(QtCore.QSize(0, 0))
        LeapSentencingDialog.setMaximumSize(QtCore.QSize(2500, 3500))
        ...
        LeapSentencingDialog.setPalette(palette)
        font = QtGui.QFont()
        ...
        font.setWeight(75)
        LeapSentencingDialog.setFont(font)
        LeapSentencingDialog.setToolTip("")
        LeapSentencingDialog.setStyleSheet("background-color: rgb(25, 49, 91);\n"
"font: 75 10pt \"Palatino Linotype\";\n"
"font-weight: bold;")
        LeapSentencingDialog.setSizeGripEnabled(True)
        LeapSentencingDialog.setModal(True)
        self.verticalLayout = QtWidgets.QVBoxLayout(LeapSentencingDialog)
        self.verticalLayout.setObjectName("verticalLayout")
        self.scrollArea = QtWidgets.QScrollArea(LeapSentencingDialog)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.leap_plea_date = NoScrollDateEdit(self.case_name_Frame)
        self.leap_plea_date.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(255, 255, 255);")
        self.leap_plea_date.setCalendarPopup(True)
        self.leap_plea_date.setObjectName("leap_plea_date")
        self.gridLayout.addWidget(self.leap_plea_date, 5, 3, 1, 1)
...
"")
        ...
        self.fra_in_court_box.addItem("")
        self.fra_in_court_box.addItem("")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.fra_in_court_box)
        ...
        self.fra_in_file_box.addItem("")
        self.fra_in_file_box.addItem("")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.fra_in_file_box)
        ...
        self.retranslateUi(LeapSentencingDialog)
        ...
        LeapSentencingDialog.setTabOrder(self.case_number_lineEdit, self.court_costs_box)
        ...
        LeapSentencingDialog.setTabOrder(self.balance_due_date, self.license_suspension_checkBox)
    ...
    def retranslateUi(self, LeapSentencingDialog):
        ...
        LeapSentencingDialog.setWindowTitle(_translate("LeapSentencingDialog", "LEAP Sentencing Case Information"))
        self.no_contest_all_Button.setText(_translate("LeapSentencingDialog", "No Contest All"))
        self.statute_label.setText(_translate("LeapSentencingDialog", "Statute:"))
        self.allied_label.setText(_translate("LeapSentencingDialog", "Allied:"))
        self.plea_label.setText(_translate("LeapSentencingDialog", "Plea:"))
        self.degree_label.setText(_translate("LeapSentencingDialog", "Degree:"))
        self.finding_label.setText(_translate("LeapSentencingDialog", "Finding:"))
        self.offense_label.setText(_translate("LeapSentencingDialog", "Offense:"))
        self.fines_suspended_label.setText(_translate("LeapSentencingDialog", "Fines Suspended:"))
        self.fines_label.setText(_translate("LeapSentencingDialog", "Fines:"))
        self.dismissed_label.setText(_translate("LeapSentencingDialog", "Dismissed:"))
        self.guilty_all_Button.setText(_translate("LeapSentencingDialog", "Guilty All"))
        self.add_charge_Button.setText(_translate("LeapSentencingDialog", "Add Charge"))
        self.label_11.setText(_translate("LeapSentencingDialog", "Court Costs:"))
        self.label_9.setText(_translate("LeapSentencingDialog", "Time to pay:"))
        self.ability_to_pay_box.setItemText(0, _translate("LeapSentencingDialog", "forthwith"))
        self.ability_to_pay_box.setItemText(1, _translate("LeapSentencingDialog", "within 30 days"))
        self.ability_to_pay_box.setItemText(2, _translate("LeapSentencingDialog", "within 60 days"))
        self.ability_to_pay_box.setItemText(3, _translate("LeapSentencingDialog", "within 90 days"))
        self.label_18.setText(_translate("LeapSentencingDialog", "Due date:"))
        self.credit_for_jail_checkBox.setText(_translate("LeapSentencingDialog", "Credit $50/day in jail"))
        self.jail_time_credit_box.setPlaceholderText(_translate("LeapSentencingDialog", "Days in jail"))
        self.court_costs_box.setItemText(0, _translate("LeapSentencingDialog", "Yes"))
        self.court_costs_box.setItemText(1, _translate("LeapSentencingDialog", "Waived"))
        self.court_costs_box.setItemText(2, _translate("LeapSentencingDialog", "Imposed in companion case"))
        self.court_costs_box.setItemText(3, _translate("LeapSentencingDialog", "No"))
        self.costs_and_fines_Button.setText(_translate("LeapSentencingDialog", "Show Costs/Fines"))
        self.label.setText(_translate("LeapSentencingDialog", "Def. First Name:"))
        self.cancel_Button.setText(_translate("LeapSentencingDialog", "Cancel"))
        self.appearance_reason_box.setItemText(0, _translate("LeapSentencingDialog", "LEAP sentencing"))
        self.label_3.setText(_translate("LeapSentencingDialog", "Case Number:"))
        self.label_26.setText(_translate("LeapSentencingDialog", "Date:"))
        self.label_2.setText(_translate("LeapSentencingDialog", "Def. Last Name:"))
        self.label_4.setText(_translate("LeapSentencingDialog", "Appearance Reason:"))
        self.clear_fields_case_Button.setText(_translate("LeapSentencingDialog", "Clear Fields"))
        self.label_8.setText(_translate("LeapSentencingDialog", "Def. Counsel:"))
        self.defense_counsel_type_box.setItemText(0, _translate("LeapSentencingDialog", "Public Defender"))
        self.defense_counsel_type_box.setItemText(1, _translate("LeapSentencingDialog", "Private Counsel"))
        self.defense_counsel_waived_checkBox.setText(_translate("LeapSentencingDialog", "Defendant waived right to counsel"))
        self.label_6.setText(_translate("LeapSentencingDialog", "LEAP Plea Date:"))
        self.label_24.setText(_translate("LeapSentencingDialog", "ADDITIONAL CONDITIONS"))
        self.license_suspension_checkBox.setText(_translate("LeapSentencingDialog", "License Suspension           "))
        self.community_service_checkBox.setText(_translate("LeapSentencingDialog", "Community Service             "))
        self.add_conditions_Button.setText(_translate("LeapSentencingDialog", "Add Conditions"))
        self.other_conditions_checkBox.setText(_translate("LeapSentencingDialog", "Other                                                      "))
        self.close_dialog_Button.setText(_translate("LeapSentencingDialog", "Close Dialog"))
        self.create_entry_Button.setText(_translate("LeapSentencingDialog", "Open Entry"))
        self.label_22.setText(_translate("LeapSentencingDialog", "FRA shown in court:"))
        self.label_21.setText(_translate("LeapSentencingDialog", "FRA shown in complaint:"))
        self.fra_in_court_box.setItemText(0, _translate("LeapSentencingDialog", "N/A"))
        self.fra_in_court_box.setItemText(1, _translate("LeapSentencingDialog", "Yes"))
        self.fra_in_court_box.setItemText(2, _translate("LeapSentencingDialog", "No"))
