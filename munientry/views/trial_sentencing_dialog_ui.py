...
"font-weight: bold;")
        ...
        self.gridLayout_8.addWidget(self.distracted_driving_checkBox, 0, 0, 1, 2)
        ...
        self.fra_in_court_box.addItem("")
        self.fra_in_court_box.addItem("")
        self.gridLayout_8.addWidget(self.fra_in_court_box, 2, 1, 1, 1)
    ...
    def retranslateUi(self, TrialSentencingDialog):
        ...
        self.court_costs_box.setItemText(4, _translate("TrialSentencingDialog", "No Costs or Fines"))
        ...
        self.distracted_driving_checkBox.setText(_translate("TrialSentencingDialog", "Add Distracted Driving Course Language"))
