...
"font-weight: bold;")
    ...
    def retranslateUi(self, TermsCommControlDialog):
        ...
        self.defense_counsel_type_box.setItemText(0, _translate("TermsCommControlDialog", "Public Defender"))
        self.defense_counsel_type_box.setItemText(1, _translate("TermsCommControlDialog", "Private Counsel"))
        self.label_24.setText(_translate("TermsCommControlDialog", "Def. Counsel:"))
        self.defense_counsel_waived_checkBox.setText(_translate("TermsCommControlDialog", "Defendant appeared without counsel"))
        ...
        self.label_4.setText(_translate("TermsCommControlDialog", "<html><head/><body><p><span style=\" text-decoration: underline;\">ENTRY CONTENT</span></p></body></html>"))
