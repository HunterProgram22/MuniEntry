# Form implementation generated from reading ui file 'munientry/views/ui/FailureToAppearDialog.ui'
#
...
class Ui_FailureToAppearDialog(object):
    def setupUi(self, FailureToAppearDialog):
        ...
        FailureToAppearDialog.setWindowModality(QtCore.Qt.WindowModality.NonModal)
        FailureToAppearDialog.setEnabled(True)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.set_bond_checkBox.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
...
"font-weight: bold;")
        ...
        self.gridLayout_3.addWidget(self.non_resident_license_checkBox, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.supplemental_summons_checkBox, 4, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.bond_forfeited_checkBox, 4, 0, 1, 1)
        self.set_no_trial_checkBox = QtWidgets.QCheckBox(self.frame)
        self.set_no_trial_checkBox.setObjectName("set_no_trial_checkBox")
        self.gridLayout_3.addWidget(self.set_no_trial_checkBox, 5, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.operator_license_checkBox, 6, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.proof_of_service_checkBox, 5, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.registration_block_checkBox, 6, 1, 1, 1)
        self.arrest_warrant_radius_box = NoScrollComboBox(self.frame)
        ...
        self.arrest_warrant_radius_box.addItem("")
        self.arrest_warrant_radius_box.addItem("")
        self.gridLayout_3.addWidget(self.arrest_warrant_radius_box, 3, 0, 1, 1)
        self.surety_appear_checkBox = QtWidgets.QCheckBox(self.frame)
        self.surety_appear_checkBox.setObjectName("surety_appear_checkBox")
        self.gridLayout_3.addWidget(self.surety_appear_checkBox, 0, 1, 1, 1)
        ...
        self.arrest_warrant_radius_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
    ...
    def retranslateUi(self, FailureToAppearDialog):
        ...
        self.bond_amount_box.setItemText(8, _translate("FailureToAppearDialog", "$7,500"))
