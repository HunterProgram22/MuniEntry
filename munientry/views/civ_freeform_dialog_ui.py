...
"font-weight: bold;")
    ...
    def retranslateUi(self, CivFreeformDialog):
        ...
        self.label_26.setText(_translate("CivFreeformDialog", "Date:"))
        ...
        self.appearance_reason_box.setItemText(0, _translate("CivFreeformDialog", "motion hearing"))
        self.appearance_reason_box.setItemText(1, _translate("CivFreeformDialog", "change of plea"))
        self.appearance_reason_box.setItemText(2, _translate("CivFreeformDialog", "arraignment"))
        self.appearance_reason_box.setItemText(3, _translate("CivFreeformDialog", "final community control violation hearing"))
        self.appearance_reason_box.setItemText(4, _translate("CivFreeformDialog", "preliminary community control violation hearing"))
        self.appearance_reason_box.setItemText(5, _translate("CivFreeformDialog", "final pre-trial"))
        self.appearance_reason_box.setItemText(6, _translate("CivFreeformDialog", "LEAP sentencing"))
        self.appearance_reason_box.setItemText(7, _translate("CivFreeformDialog", "jury trial"))
        self.appearance_reason_box.setItemText(8, _translate("CivFreeformDialog", "trial to court"))
        self.appearance_reason_box.setItemText(9, _translate("CivFreeformDialog", "warrant for failure to appear"))
