...
class Ui_DiversionPleaDialog(object):
    def setupUi(self, DiversionPleaDialog):
        ...
        DiversionPleaDialog.resize(1301, 823)
...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, -25, 1264, 1071))
        ...
        self.gridLayout_8.addWidget(self.pay_restitution_amount_line, 9, 3, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.other_conditions_check_box, 10, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.other_conditions_text, 10, 2, 1, 2)
        ...
        self.buttonGroup.addButton(self.marijuana_diversion_radio_btn)
        self.gridLayout_8.addWidget(self.marijuana_diversion_radio_btn, 1, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.pay_restitution_check_box, 8, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.pay_restitution_to_line, 8, 3, 1, 1)
        ...
        self.buttonGroup.addButton(self.theft_diversion_radio_btn)
        self.gridLayout_8.addWidget(self.theft_diversion_radio_btn, 2, 0, 1, 1)
        self.label_23 = QtWidgets.QLabel(self.diversion_frame)
        self.label_23.setObjectName("label_23")
        self.gridLayout_8.addWidget(self.label_23, 3, 2, 1, 1)
        self.label_11 = QtWidgets.QLabel(self.diversion_frame)
        self.label_11.setObjectName("label_11")
        self.gridLayout_8.addWidget(self.label_11, 1, 2, 1, 1)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_8.addWidget(self.diversion_fine_pay_date, 3, 3, 1, 1)
        self.diversion_completion_date = NoScrollDateEdit(self.diversion_frame)
        self.diversion_completion_date.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(255, 255, 255);")
        self.diversion_completion_date.setObjectName("diversion_completion_date")
        self.gridLayout_8.addWidget(self.diversion_completion_date, 1, 3, 1, 1)
        self.label_13 = QtWidgets.QLabel(self.diversion_frame)
        self.label_13.setObjectName("label_13")
        self.gridLayout_8.addWidget(self.label_13, 4, 2, 1, 2)
        ...
        self.buttonGroup.addButton(self.other_diversion_radio_btn)
        self.gridLayout_8.addWidget(self.other_diversion_radio_btn, 3, 0, 1, 1)
        self.label_15 = QtWidgets.QLabel(self.diversion_frame)
        self.label_15.setObjectName("label_15")
        self.gridLayout_8.addWidget(self.label_15, 5, 2, 1, 2)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, DiversionPleaDialog):
        ...
        self.probation_check_box.setText(_translate("DiversionPleaDialog", " Add General Probation Conditions - 1 Year Term"))
        self.other_conditions_check_box.setText(_translate("DiversionPleaDialog", "Add Other Conditions"))
        self.label_9.setText(_translate("DiversionPleaDialog", "DIVERSION DETAILS"))
        self.marijuana_diversion_radio_btn.setText(_translate("DiversionPleaDialog", "Marijuana Diversion Program"))
        self.pay_restitution_check_box.setText(_translate("DiversionPleaDialog", "Restitution Ordered"))
        self.label_6.setText(_translate("DiversionPleaDialog", "Diversion Completion date is set to 90 days from today."))
        self.theft_diversion_radio_btn.setText(_translate("DiversionPleaDialog", "Theft Diversion Program"))
        self.label_23.setText(_translate("DiversionPleaDialog", "Fine Due Date"))
        self.label_11.setText(_translate("DiversionPleaDialog", "Diversion Completion Date:"))
        self.label_13.setText(_translate("DiversionPleaDialog", "Fine Due Date is set to first Tuesday after 120 days from today. Fines only due if Defendant fails Diversion."))
        self.other_diversion_radio_btn.setText(_translate("DiversionPleaDialog", "Other Diversion Program"))
        self.label_15.setText(_translate("DiversionPleaDialog", "If any Jail Days are imposed for failure to complete Diversion, the entry will order they be set through Community Control."))
