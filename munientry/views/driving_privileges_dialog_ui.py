...
"background-color: rgb(255, 255, 255);")
        ...
        self.other_checkBox = QtWidgets.QCheckBox(self.frame_5)
        self.other_checkBox.setObjectName("other_checkBox")
        self.gridLayout_3.addWidget(self.other_checkBox, 5, 3, 1, 1)
    ...
    def retranslateUi(self, DrivingPrivilegesDialog):
        ...
        self.other_checkBox.setText(_translate("DrivingPrivilegesDialog", "Other"))
