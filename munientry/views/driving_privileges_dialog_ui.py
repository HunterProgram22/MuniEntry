...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1114, 955))
...
"font-weight: bold;")
    ...
    def retranslateUi(self, DrivingPrivilegesDialog):
        ...
        self.suspension_term_box.setItemText(3, _translate("DrivingPrivilegesDialog", "18 Months"))
        self.suspension_term_box.setItemText(4, _translate("DrivingPrivilegesDialog", "2 Years"))
        self.suspension_term_box.setItemText(5, _translate("DrivingPrivilegesDialog", "3 Years"))
        self.suspension_term_box.setItemText(6, _translate("DrivingPrivilegesDialog", "4 Years"))
        self.suspension_term_box.setItemText(7, _translate("DrivingPrivilegesDialog", "5 Years"))
        self.suspension_term_box.setItemText(8, _translate("DrivingPrivilegesDialog", "6 Years"))
        self.suspension_term_box.setItemText(9, _translate("DrivingPrivilegesDialog", "7 Years"))
