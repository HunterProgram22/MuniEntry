...
"font-weight: bold;")
        ...
        self.entry_content_textEdit = QtWidgets.QPlainTextEdit(self.frame)
        ...
        self.gridLayout_6.addWidget(self.entry_content_textEdit, 7, 0, 1, 4)
        ...
        self.state_response_box.addItem("")
        self.gridLayout_6.addWidget(self.state_response_box, 5, 1, 1, 1)
...
"color: rgb(0, 0, 0);")
        ...
        self.seal_decision_box.addItem("")
        self.seal_decision_box.addItem("")
        self.gridLayout_6.addWidget(self.seal_decision_box, 6, 1, 1, 1)
        ...
        CriminalSealingEntryDialog.setTabOrder(self.defendant_last_name_lineEdit, self.case_number_lineEdit)
        CriminalSealingEntryDialog.setTabOrder(self.case_number_lineEdit, self.defense_counsel_name_box)
        ...
        CriminalSealingEntryDialog.setTabOrder(self.defense_counsel_waived_checkBox, self.state_response_box)
        CriminalSealingEntryDialog.setTabOrder(self.state_response_box, self.entry_content_textEdit)
        CriminalSealingEntryDialog.setTabOrder(self.entry_content_textEdit, self.create_entry_Button)
