...
"background-color: rgb(255, 255, 255);")
        ...
        self.langugage_box = NoScrollComboBox(self.frame_5)
        self.langugage_box.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.langugage_box.setEditable(True)
        self.langugage_box.setObjectName("langugage_box")
        self.langugage_box.addItem("")
        self.langugage_box.setItemText(0, "")
        self.langugage_box.addItem("")
        self.langugage_box.addItem("")
        self.langugage_box.addItem("")
        self.langugage_box.addItem("")
        self.gridLayout_3.addWidget(self.langugage_box, 1, 1, 1, 1)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, GeneralNoticeOfHearingDialog):
        ...
        self.langugage_box.setItemText(1, _translate("GeneralNoticeOfHearingDialog", "Spanish"))
        self.langugage_box.setItemText(2, _translate("GeneralNoticeOfHearingDialog", "Porteguese"))
        self.langugage_box.setItemText(3, _translate("GeneralNoticeOfHearingDialog", "Nepali"))
        self.langugage_box.setItemText(4, _translate("GeneralNoticeOfHearingDialog", "Vietnamese"))
