...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, GeneralNoticeOfHearingDialog):
        ...
        self.hearing_type_box.setItemText(4, _translate("GeneralNoticeOfHearingDialog", "Motion to Suppress Hearing"))
        self.hearing_type_box.setItemText(5, _translate("GeneralNoticeOfHearingDialog", "Motion to Modify Bond"))
        self.hearing_type_box.setItemText(6, _translate("GeneralNoticeOfHearingDialog", "Oral Hearing on"))
        self.hearing_type_box.setItemText(7, _translate("GeneralNoticeOfHearingDialog", "Plea Hearing"))
        self.hearing_type_box.setItemText(8, _translate("GeneralNoticeOfHearingDialog", "Preliminary Community Control Violation Hearing"))
        self.hearing_type_box.setItemText(9, _translate("GeneralNoticeOfHearingDialog", "Seal Record"))
        self.hearing_type_box.setItemText(10, _translate("GeneralNoticeOfHearingDialog", "Status Hearing"))
        self.hearing_type_box.setItemText(11, _translate("GeneralNoticeOfHearingDialog", "Surety Hearing"))
