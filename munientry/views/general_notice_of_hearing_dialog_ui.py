...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1144, 774))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.hearing_type_box.setItemText(0, "")
        self.hearing_type_box.addItem("")
        self.hearing_type_box.addItem("")
        self.hearing_type_box.addItem("")
        self.hearing_type_box.addItem("")
        ...
        self.hearing_type_box.addItem("")
        self.hearing_type_box.addItem("")
        self.gridLayout_3.addWidget(self.hearing_type_box, 3, 1, 1, 1)
        ...
        self.hearing_location_box.addItem("")
        self.hearing_location_box.addItem("")
        self.gridLayout_3.addWidget(self.hearing_location_box, 6, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.hearing_date_label, 4, 0, 1, 1)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_3.addWidget(self.hearing_date, 4, 1, 1, 1)
        ...
        self.hearing_time_box.addItem("")
        self.hearing_time_box.addItem("")
        self.gridLayout_3.addWidget(self.hearing_time_box, 5, 1, 1, 1)
        self.hearing_type_label = QtWidgets.QLabel(self.frame_5)
        self.hearing_type_label.setObjectName("hearing_type_label")
        self.gridLayout_3.addWidget(self.hearing_type_label, 3, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.dates_confirmed_check_box, 2, 0, 1, 1)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, GeneralNoticeOfHearingDialog):
        ...
        self.hearing_type_box.setItemText(1, _translate("GeneralNoticeOfHearingDialog", "Competency Hearing"))
        self.hearing_type_box.setItemText(2, _translate("GeneralNoticeOfHearingDialog", "Final Community Control Violation Hearing"))
        self.hearing_type_box.setItemText(3, _translate("GeneralNoticeOfHearingDialog", "Motion Hearing"))
        self.hearing_type_box.setItemText(4, _translate("GeneralNoticeOfHearingDialog", "Motion for Competency Evaluation"))
        self.hearing_type_box.setItemText(5, _translate("GeneralNoticeOfHearingDialog", "Motion to Suppress Hearing"))
        self.hearing_type_box.setItemText(6, _translate("GeneralNoticeOfHearingDialog", "Motion to Modify Bond"))
        self.hearing_type_box.setItemText(7, _translate("GeneralNoticeOfHearingDialog", "Oral Hearing on"))
        self.hearing_type_box.setItemText(8, _translate("GeneralNoticeOfHearingDialog", "Oral Hearing to Seal Record"))
        self.hearing_type_box.setItemText(9, _translate("GeneralNoticeOfHearingDialog", "Plea Hearing"))
        self.hearing_type_box.setItemText(10, _translate("GeneralNoticeOfHearingDialog", "Preliminary Community Control Violation Hearing"))
        self.hearing_type_box.setItemText(11, _translate("GeneralNoticeOfHearingDialog", "Status Hearing"))
        self.hearing_type_box.setItemText(12, _translate("GeneralNoticeOfHearingDialog", "Surety Hearing"))
        ...
        self.dates_confirmed_check_box.setText(_translate("GeneralNoticeOfHearingDialog", "Dates Confirmed with Counsel"))
