...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, CompetencyDialog):
        ...
        self.comboBox.setItemText(0, _translate("CompetencyDialog", "Found Competent"))
        self.comboBox.setItemText(1, _translate("CompetencyDialog", "Found Competent - Not Insane"))
        self.comboBox.setItemText(2, _translate("CompetencyDialog", "Not Competent - Not Restorable"))
        self.comboBox.setItemText(3, _translate("CompetencyDialog", "Not Competent - Restorable"))
        self.comboBox.setItemText(4, _translate("CompetencyDialog", "Not Restored to Competency - Dismiss"))
