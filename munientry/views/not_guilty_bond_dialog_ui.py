...
"font-weight: bold;")
        ...
        self.fingerprint_court_checkBox = ConditionCheckbox(self.bond_conditions_frame)
        self.fingerprint_court_checkBox.setObjectName("fingerprint_court_checkBox")
        self.gridLayout_2.addWidget(self.fingerprint_court_checkBox, 2, 1, 1, 1)
    ...
    def retranslateUi(self, NotGuiltyBondDialog):
        ...
        self.fingerprint_court_checkBox.setText(_translate("NotGuiltyBondDialog", "Fingerprinted by court staff prior to leaving"))
