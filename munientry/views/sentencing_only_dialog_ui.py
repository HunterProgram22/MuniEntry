...
class Ui_SentencingOnlyDialog(object):
    def setupUi(self, SentencingOnlyDialog):
        SentencingOnlyDialog.setObjectName("SentencingOnlyDialog")
        SentencingOnlyDialog.setWindowModality(QtCore.Qt.WindowModality.NonModal)
        SentencingOnlyDialog.setEnabled(True)
        SentencingOnlyDialog.resize(1098, 815)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(SentencingOnlyDialog.sizePolicy().hasHeightForWidth())
        SentencingOnlyDialog.setSizePolicy(sizePolicy)
        SentencingOnlyDialog.setMinimumSize(QtCore.QSize(0, 0))
        SentencingOnlyDialog.setMaximumSize(QtCore.QSize(2500, 3500))
        ...
        SentencingOnlyDialog.setPalette(palette)
        font = QtGui.QFont()
        ...
        font.setWeight(75)
        SentencingOnlyDialog.setFont(font)
        SentencingOnlyDialog.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        SentencingOnlyDialog.setToolTip("")
        SentencingOnlyDialog.setStyleSheet("background-color: rgb(25, 49, 91);\n"
"font: 75 10pt \"Palatino Linotype\";\n"
"font-weight: bold;")
        SentencingOnlyDialog.setSizeGripEnabled(True)
        SentencingOnlyDialog.setModal(True)
        self.verticalLayout = QtWidgets.QVBoxLayout(SentencingOnlyDialog)
        self.verticalLayout.setObjectName("verticalLayout")
        self.scrollArea = QtWidgets.QScrollArea(SentencingOnlyDialog)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 1082, 875))
...
"font-weight: bold;")
        ...
        self.label_15 = QtWidgets.QLabel(self.case_name_Frame)
        ...
        self.gridLayout.addWidget(self.offense_of_violence_checkBox, 4, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.victim_statements_checkBox, 4, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.case_number_lineEdit, 1, 4, 1, 1)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout.addWidget(self.plea_trial_date, 0, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.defense_counsel_waived_checkBox, 2, 4, 1, 1)
        self.plea_date = NoScrollDateEdit(self.case_name_Frame)
        self.plea_date.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(255, 255, 255);")
        self.plea_date.setCalendarPopup(True)
        self.plea_date.setObjectName("plea_date")
        self.gridLayout.addWidget(self.plea_date, 4, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.cancel_Button, 0, 5, 1, 2)
        ...
        self.gridLayout.addWidget(self.clear_fields_case_Button, 1, 5, 1, 2)
        ...
        self.defense_counsel_type_box.addItem("")
        self.gridLayout.addWidget(self.defense_counsel_type_box, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.defendant_last_name_lineEdit, 1, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.defendant_first_name_lineEdit, 0, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.defense_counsel_name_box, 2, 1, 1, 2)
        ...
        SentencingOnlyDialog.setTabOrder(self.appearance_reason_box, self.court_costs_box)
        ...
        SentencingOnlyDialog.setTabOrder(self.balance_due_date, self.fra_in_file_box)
    ...
    def retranslateUi(self, SentencingOnlyDialog):
        ...
        SentencingOnlyDialog.setWindowTitle(_translate("SentencingOnlyDialog", "Sentencing Only Case Information"))
        self.label_11.setText(_translate("SentencingOnlyDialog", "Court Costs:"))
        self.court_costs_box.setItemText(0, _translate("SentencingOnlyDialog", "Yes"))
        self.court_costs_box.setItemText(1, _translate("SentencingOnlyDialog", "Waived"))
        self.court_costs_box.setItemText(2, _translate("SentencingOnlyDialog", "Imposed in companion case"))
        self.court_costs_box.setItemText(3, _translate("SentencingOnlyDialog", "No"))
        self.label_9.setText(_translate("SentencingOnlyDialog", "Time to pay:"))
        self.ability_to_pay_box.setItemText(0, _translate("SentencingOnlyDialog", "forthwith"))
        ...
        self.ability_to_pay_box.setItemText(4, _translate("SentencingOnlyDialog", "while on Community Control"))
        self.ability_to_pay_box.setItemText(5, _translate("SentencingOnlyDialog", "while on the OVI Docket"))
        self.ability_to_pay_box.setItemText(6, _translate("SentencingOnlyDialog", "while on Mission Court"))
        self.ability_to_pay_box.setItemText(7, _translate("SentencingOnlyDialog", "while on the Mental Health Docket"))
        ...
        self.impoundment_checkBox.setText(_translate("SentencingOnlyDialog", "Immobilize/Impound               "))
        self.community_control_checkBox.setText(_translate("SentencingOnlyDialog", "Community Control                     "))
        self.license_suspension_checkBox.setText(_translate("SentencingOnlyDialog", "License Suspension                  "))
        self.community_service_checkBox.setText(_translate("SentencingOnlyDialog", "Community Service                   "))
        self.add_conditions_label.setText(_translate("SentencingOnlyDialog", "ADDITIONAL CONDITIONS"))
        self.add_conditions_Button.setText(_translate("SentencingOnlyDialog", "Add Additional Conditions"))
        self.other_conditions_checkBox.setText(_translate("SentencingOnlyDialog", "Other                                              "))
        self.companion_cases_sentence_label.setText(_translate("SentencingOnlyDialog", "Companion Case Jail Time Served:"))
        self.companion_cases_sentence_box.setItemText(0, _translate("SentencingOnlyDialog", "consecutively"))
        self.companion_cases_sentence_box.setItemText(1, _translate("SentencingOnlyDialog", "concurrently"))
        self.jail_time_credit_apply_box.setItemText(1, _translate("SentencingOnlyDialog", "Costs and Fines"))
        self.jail_time_credit_apply_box.setItemText(2, _translate("SentencingOnlyDialog", "Sentence"))
        self.jail_time_credit_label.setText(_translate("SentencingOnlyDialog", "JAIL CREDIT AND REPORTING"))
        self.label_6.setText(_translate("SentencingOnlyDialog", "Currently In Jail:"))
        self.label_16.setText(_translate("SentencingOnlyDialog", "Apply JTC to:"))
        self.in_jail_box.setItemText(1, _translate("SentencingOnlyDialog", "Yes"))
        self.in_jail_box.setItemText(2, _translate("SentencingOnlyDialog", "No"))
        self.label_13.setText(_translate("SentencingOnlyDialog", "Days In Jail:"))
        self.add_companion_cases_checkBox.setText(_translate("SentencingOnlyDialog", "Add Companion Cases"))
        self.add_jail_report_Button.setText(_translate("SentencingOnlyDialog", "Add Jail Report Date"))
        self.jail_checkBox.setText(_translate("SentencingOnlyDialog", "Set Jail Reporting Terms - This must be checked before adding report date"))
        self.label_21.setText(_translate("SentencingOnlyDialog", "FRA shown in complaint:"))
        self.fra_in_file_box.setItemText(0, _translate("SentencingOnlyDialog", "N/A"))
        self.fra_in_file_box.setItemText(1, _translate("SentencingOnlyDialog", "Yes"))
        self.fra_in_file_box.setItemText(2, _translate("SentencingOnlyDialog", "No"))
        self.label_22.setText(_translate("SentencingOnlyDialog", "FRA shown in court:"))
        self.fra_in_court_box.setItemText(0, _translate("SentencingOnlyDialog", "N/A"))
        self.fra_in_court_box.setItemText(1, _translate("SentencingOnlyDialog", "Yes"))
        self.fra_in_court_box.setItemText(2, _translate("SentencingOnlyDialog", "No"))
        self.create_entry_Button.setText(_translate("SentencingOnlyDialog", "Open Entry"))
        self.close_dialog_Button.setText(_translate("SentencingOnlyDialog", "Close Dialog"))
        self.no_contest_all_Button.setText(_translate("SentencingOnlyDialog", "No Contest All"))
        self.guilty_all_Button.setText(_translate("SentencingOnlyDialog", "Guilty All"))
        self.add_charge_Button.setText(_translate("SentencingOnlyDialog", "Add Charge"))
        self.label_14.setText(_translate("SentencingOnlyDialog", "Finding:"))
        self.label_12.setText(_translate("SentencingOnlyDialog", "Jail Days Suspended:"))
        self.label_10.setText(_translate("SentencingOnlyDialog", "Fines Suspended:"))
        self.label_20.setText(_translate("SentencingOnlyDialog", "Degree:"))
        self.label_17.setText(_translate("SentencingOnlyDialog", "Fines:"))
        self.label_8.setText(_translate("SentencingOnlyDialog", "Jail Days:"))
        self.offense_label_1.setText(_translate("SentencingOnlyDialog", "Offense:"))
        self.label_19.setText(_translate("SentencingOnlyDialog", "Statute:"))
        self.label_25.setText(_translate("SentencingOnlyDialog", "Dismissed:"))
        self.label_7.setText(_translate("SentencingOnlyDialog", "Allied:"))
        self.plea_label_1.setText(_translate("SentencingOnlyDialog", "Plea:"))
        self.label_2.setText(_translate("SentencingOnlyDialog", "Def. Last Name:"))
        self.label_24.setText(_translate("SentencingOnlyDialog", "Def. Counsel:"))
        self.label.setText(_translate("SentencingOnlyDialog", "Def. First Name:"))
        self.appearance_reason_box.setItemText(0, _translate("SentencingOnlyDialog", "sentencing"))
        self.label_27.setText(_translate("SentencingOnlyDialog", "Appearance Reason:"))
        self.label_15.setText(_translate("SentencingOnlyDialog", "Plea Date:"))
        self.offense_of_violence_checkBox.setText(_translate("SentencingOnlyDialog", "Offense of Violence                                    "))
        self.victim_statements_checkBox.setText(_translate("SentencingOnlyDialog", "Court Heard Victim Statements"))
        self.defense_counsel_waived_checkBox.setText(_translate("SentencingOnlyDialog", "Defendant waived right to counsel"))
        self.cancel_Button.setText(_translate("SentencingOnlyDialog", "Cancel"))
        self.clear_fields_case_Button.setText(_translate("SentencingOnlyDialog", "Clear Fields"))
        self.defense_counsel_type_box.setItemText(0, _translate("SentencingOnlyDialog", "Public Defender"))
