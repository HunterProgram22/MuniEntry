...
class Ui_JailCCPleaDialog(object):
    def setupUi(self, JailCCPleaDialog):
        ...
        JailCCPleaDialog.resize(1223, 948)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, JailCCPleaDialog):
        ...
        self.report_type_box.setItemText(0, _translate("JailCCPleaDialog", "future date"))
        self.report_type_box.setItemText(1, _translate("JailCCPleaDialog", "forthwith"))
        self.report_type_box.setItemText(2, _translate("JailCCPleaDialog", "date set by Office of Community Control"))
