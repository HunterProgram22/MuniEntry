...
class Ui_JailCCPleaDialog(object):
    def setupUi(self, JailCCPleaDialog):
        ...
        JailCCPleaDialog.resize(1221, 941)
...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, -667, 1184, 1881))
        ...
        self.gridLayout_10.addWidget(self.close_dialog_Button, 10, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.create_entry_Button, 9, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.frame_2, 10, 1, 1, 1)
...
"font-weight: bold;")
        ...
        self.gridLayout_2.addWidget(self.community_control_checkBox, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.community_service_checkBox, 3, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.victim_notification_checkBox, 2, 1, 1, 1)
        self.impoundment_checkBox = QtWidgets.QCheckBox(self.frame_6)
        self.impoundment_checkBox.setObjectName("impoundment_checkBox")
        self.gridLayout_2.addWidget(self.impoundment_checkBox, 3, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.other_conditions_checkBox, 5, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.fra_frame, 8, 0, 1, 1)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_10.addWidget(self.costs_frame, 7, 0, 1, 1)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.jail_checkBox = QtWidgets.QCheckBox(self.jail_reporting_frame)
        self.jail_checkBox.setObjectName("jail_checkBox")
        self.gridLayout_11.addWidget(self.jail_checkBox, 0, 0, 1, 2)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_10.addWidget(self.license_suspension_frame, 5, 0, 1, 1)
        ...
        JailCCPleaDialog.setTabOrder(self.add_charge_Button, self.community_control_checkBox)
        JailCCPleaDialog.setTabOrder(self.community_control_checkBox, self.victim_notification_checkBox)
        JailCCPleaDialog.setTabOrder(self.victim_notification_checkBox, self.community_service_checkBox)
