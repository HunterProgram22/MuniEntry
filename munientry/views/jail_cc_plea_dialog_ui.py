...
class Ui_JailCCPleaDialog(object):
    def setupUi(self, JailCCPleaDialog):
        ...
        JailCCPleaDialog.resize(1289, 895)
...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, -339, 1252, 1451))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_4.addWidget(self.case_name_Frame, 0, 0, 1, 1)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_4.addWidget(self.diversion_frame, 1, 0, 1, 1)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_4.addWidget(self.costs_frame, 5, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.fra_frame, 6, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.create_entry_Button, 7, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.close_dialog_Button, 8, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.frame_2, 8, 1, 1, 1)
        self.jail_details_frame = QtWidgets.QFrame(self.scrollAreaWidgetContents_2)
        font = QtGui.QFont()
        font.setFamily("Palatino Linotype")
        font.setPointSize(9)
        font.setBold(True)
        font.setItalic(False)
        font.setWeight(75)
        self.jail_details_frame.setFont(font)
        self.jail_details_frame.setStyleSheet("background-color: rgb(240, 240, 240);\n"
"font: 75 9pt \"Palatino Linotype\";\n"
"font-weight: bold;")
        self.jail_details_frame.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.jail_details_frame.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.jail_details_frame.setLineWidth(2)
        self.jail_details_frame.setObjectName("jail_details_frame")
        self.gridLayout_6 = QtWidgets.QGridLayout(self.jail_details_frame)
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.add_companion_cases_checkBox = QtWidgets.QCheckBox(self.jail_details_frame)
        self.add_companion_cases_checkBox.setObjectName("add_companion_cases_checkBox")
        self.gridLayout_6.addWidget(self.add_companion_cases_checkBox, 12, 0, 2, 1)
        self.label_32 = QtWidgets.QLabel(self.jail_details_frame)
        font = QtGui.QFont()
        font.setFamily("Palatino Linotype")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.gridLayout_6.addWidget(self.label_32, 1, 2, 1, 2)
        self.report_type_box = NoScrollComboBox(self.jail_details_frame)
        ...
        self.report_type_box.addItem("")
        self.report_type_box.addItem("")
        self.gridLayout_6.addWidget(self.report_type_box, 2, 3, 1, 1)
        self.report_date_label = QtWidgets.QLabel(self.jail_details_frame)
        self.report_date_label.setObjectName("report_date_label")
        self.gridLayout_6.addWidget(self.report_date_label, 3, 2, 1, 1)
        self.report_date_box = NoScrollDateEdit(self.jail_details_frame)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_6.addWidget(self.report_date_box, 3, 3, 1, 1)
        self.label_13 = QtWidgets.QLabel(self.jail_details_frame)
        self.label_13.setObjectName("label_13")
        self.gridLayout_6.addWidget(self.label_13, 3, 0, 1, 1)
        self.label_16 = QtWidgets.QLabel(self.jail_details_frame)
        self.label_16.setObjectName("label_16")
        self.gridLayout_6.addWidget(self.label_16, 4, 0, 1, 1)
        self.label_6 = QtWidgets.QLabel(self.jail_details_frame)
        self.label_6.setObjectName("label_6")
        self.gridLayout_6.addWidget(self.label_6, 2, 0, 1, 1)
        self.jail_time_credit_box = QtWidgets.QLineEdit(self.jail_details_frame)
        ...
        self.jail_time_credit_label = QtWidgets.QLabel(self.jail_details_frame)
        ...
        self.gridLayout_6.addWidget(self.jail_time_credit_label, 1, 0, 1, 2)
        self.label_29 = QtWidgets.QLabel(self.jail_details_frame)
        self.label_29.setObjectName("label_29")
        self.gridLayout_6.addWidget(self.label_29, 2, 2, 1, 1)
        self.jail_report_days_notes_box = QtWidgets.QLineEdit(self.jail_details_frame)
        ...
        self.gridLayout_6.addWidget(self.jail_report_days_notes_box, 10, 2, 1, 2)
        self.report_time_box = NoScrollTimeEdit(self.jail_details_frame)
        ...
        self.gridLayout_6.addWidget(self.report_time_box, 4, 3, 1, 1)
        self.report_time_label = QtWidgets.QLabel(self.jail_details_frame)
        self.report_time_label.setObjectName("report_time_label")
        self.gridLayout_6.addWidget(self.report_time_label, 4, 2, 1, 1)
        self.jail_time_credit_apply_box = NoScrollComboBox(self.jail_details_frame)
        ...
        self.companion_cases_box = QtWidgets.QLineEdit(self.jail_details_frame)
        ...
        self.gridLayout_6.addWidget(self.companion_cases_box, 12, 1, 1, 1)
        self.in_jail_box = NoScrollComboBox(self.jail_details_frame)
        ...
        self.jail_checkBox = QtWidgets.QCheckBox(self.jail_details_frame)
        self.jail_checkBox.setObjectName("jail_checkBox")
        self.gridLayout_6.addWidget(self.jail_checkBox, 0, 0, 1, 3)
        self.companion_cases_sentence_box = NoScrollComboBox(self.jail_details_frame)
        ...
        self.companion_cases_sentence_box.addItem("")
        self.gridLayout_6.addWidget(self.companion_cases_sentence_box, 12, 3, 1, 1)
        self.companion_cases_sentence_label = QtWidgets.QLabel(self.jail_details_frame)
        self.companion_cases_sentence_label.setObjectName("companion_cases_sentence_label")
        self.gridLayout_6.addWidget(self.companion_cases_sentence_label, 12, 2, 1, 1)
        self.label_31 = QtWidgets.QLabel(self.jail_details_frame)
        self.label_31.setObjectName("label_31")
        self.gridLayout_6.addWidget(self.label_31, 5, 2, 1, 1)
        self.jail_sentence_execution_type_box = NoScrollComboBox(self.jail_details_frame)
        ...
        self.jail_sentence_execution_type_box.addItem("")
        self.jail_sentence_execution_type_box.addItem("")
        self.gridLayout_6.addWidget(self.jail_sentence_execution_type_box, 5, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.jail_details_frame, 3, 0, 1, 1)
        ...
        JailCCPleaDialog.setTabOrder(self.add_charge_Button, self.add_companion_cases_checkBox)
        JailCCPleaDialog.setTabOrder(self.add_companion_cases_checkBox, self.community_control_checkBox)
    ...
    def retranslateUi(self, JailCCPleaDialog):
        ...
        self.jail_checkBox.setText(_translate("JailCCPleaDialog", "Jail Details -> Check to set jail credit and reporting. Checkbox must remain checked if ordering jail time."))
