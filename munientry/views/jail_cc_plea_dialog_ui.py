...
class Ui_JailCCPleaDialog(object):
    def setupUi(self, JailCCPleaDialog):
        ...
        JailCCPleaDialog.resize(1374, 912)
...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 1337, 930))
...
"font-weight: bold;")
        ...
        self.gridLayout_4.addWidget(self.jail_time_credit_frame, 3, 3, 2, 1)
        ...
        self.fra_in_file_box.addItem("")
        self.fra_in_file_box.addItem("")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.fra_in_file_box)
        self.label_22 = QtWidgets.QLabel(self.fra_frame)
        self.label_22.setObjectName("label_22")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_22)
        ...
        self.fra_in_court_box.addItem("")
        self.fra_in_court_box.addItem("")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.fra_in_court_box)
        ...
        self.gridLayout_4.addWidget(self.fra_frame, 4, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.frame_2, 5, 3, 1, 1)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_4.addWidget(self.frame_5, 3, 0, 1, 2)
        ...
        JailCCPleaDialog.setTabOrder(self.victim_statements_checkBox, self.add_charge_Button)
        ...
        JailCCPleaDialog.setTabOrder(self.balance_due_date, self.pay_today_box)
        JailCCPleaDialog.setTabOrder(self.pay_today_box, self.monthly_pay_box)
        JailCCPleaDialog.setTabOrder(self.monthly_pay_box, self.distracted_driving_checkBox)
        JailCCPleaDialog.setTabOrder(self.distracted_driving_checkBox, self.fra_in_file_box)
        ...
        JailCCPleaDialog.setTabOrder(self.community_control_checkBox, self.community_service_checkBox)
        JailCCPleaDialog.setTabOrder(self.community_service_checkBox, self.license_suspension_checkBox)
        JailCCPleaDialog.setTabOrder(self.license_suspension_checkBox, self.victim_notification_checkBox)
        JailCCPleaDialog.setTabOrder(self.victim_notification_checkBox, self.impoundment_checkBox)
        JailCCPleaDialog.setTabOrder(self.impoundment_checkBox, self.other_conditions_checkBox)
        JailCCPleaDialog.setTabOrder(self.other_conditions_checkBox, self.add_conditions_Button)
        JailCCPleaDialog.setTabOrder(self.add_conditions_Button, self.in_jail_box)
        ...
        JailCCPleaDialog.setTabOrder(self.add_jail_report_Button, self.close_dialog_Button)
    ...
    def retranslateUi(self, JailCCPleaDialog):
        ...
        self.label_21.setText(_translate("JailCCPleaDialog", "FRA shown in complaint:"))
        ...
        self.distracted_driving_checkBox.setText(_translate("JailCCPleaDialog", "Add Distracted Driving Course Language"))
        ...
        self.pay_today_label.setText(_translate("JailCCPleaDialog", "Pay Today:"))
        self.balance_due_date_label.setText(_translate("JailCCPleaDialog", "Due date:"))
        self.ability_to_pay_box.setItemText(0, _translate("JailCCPleaDialog", "forthwith"))
        self.ability_to_pay_box.setItemText(1, _translate("JailCCPleaDialog", "monthly pay"))
        self.ability_to_pay_box.setItemText(2, _translate("JailCCPleaDialog", "partial forthwith then monthly pay"))
        ...
        self.monthly_pay_label.setText(_translate("JailCCPleaDialog", "Monthly Pay:"))
