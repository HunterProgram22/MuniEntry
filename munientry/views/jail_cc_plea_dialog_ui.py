...
class Ui_JailCCPleaDialog(object):
    def setupUi(self, JailCCPleaDialog):
        ...
        JailCCPleaDialog.resize(1098, 815)
...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 1073, 879))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_5.addWidget(self.balance_due_date, 4, 1, 1, 1)
        self.checkBox = QtWidgets.QCheckBox(self.costs_frame)
        ...
        self.ability_to_pay_box.addItem("")
        self.ability_to_pay_box.addItem("")
        self.gridLayout_5.addWidget(self.ability_to_pay_box, 3, 1, 1, 1)
...
"font-weight: bold;")
    ...
    def retranslateUi(self, JailCCPleaDialog):
        ...
        self.checkBox.setText(_translate("JailCCPleaDialog", "Add Distracted Driving Course Language"))
