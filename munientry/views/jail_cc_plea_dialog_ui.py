...
"font-weight: bold;")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, -615, 1252, 1490))
...
"font-weight: bold;")
        ...
        self.line_3 = QtWidgets.QFrame(self.jail_details_frame)
        ...
        self.gridLayout_6.addWidget(self.jail_checkBox, 8, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.add_companion_cases_checkBox, 6, 0, 1, 1)
        self.add_jail_report_Button = QtWidgets.QPushButton(self.jail_details_frame)
        ...
        self.gridLayout_6.addWidget(self.add_jail_report_Button, 9, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.companion_cases_box, 6, 1, 1, 1)
        self.jail_details_check_box = QtWidgets.QCheckBox(self.jail_details_frame)
        self.jail_details_check_box.setObjectName("jail_details_check_box")
        self.gridLayout_6.addWidget(self.jail_details_check_box, 0, 0, 1, 2)
        ...
        self.gridLayout_6.addWidget(self.companion_cases_sentence_label, 7, 0, 1, 1)
        ...
        self.companion_cases_sentence_box.addItem("")
        self.gridLayout_6.addWidget(self.companion_cases_sentence_box, 7, 1, 1, 1)
...
"background-color: rgb(255, 255, 255);")
        ...
        JailCCPleaDialog.setTabOrder(self.add_charge_Button, self.jail_details_check_box)
        JailCCPleaDialog.setTabOrder(self.jail_details_check_box, self.in_jail_box)
        ...
        JailCCPleaDialog.setTabOrder(self.jail_time_credit_apply_box, self.add_companion_cases_checkBox)
        JailCCPleaDialog.setTabOrder(self.add_companion_cases_checkBox, self.companion_cases_box)
        JailCCPleaDialog.setTabOrder(self.companion_cases_box, self.companion_cases_sentence_box)
        JailCCPleaDialog.setTabOrder(self.companion_cases_sentence_box, self.jail_checkBox)
        JailCCPleaDialog.setTabOrder(self.jail_checkBox, self.add_jail_report_Button)
        JailCCPleaDialog.setTabOrder(self.add_jail_report_Button, self.community_control_checkBox)
    ...
    def retranslateUi(self, JailCCPleaDialog):
        ...
        self.jail_checkBox.setText(_translate("JailCCPleaDialog", "Set Jail Reporting Terms - This must be checked before adding report date"))
        self.add_companion_cases_checkBox.setText(_translate("JailCCPleaDialog", "Add Companion Cases"))
        self.add_jail_report_Button.setText(_translate("JailCCPleaDialog", "Add Jail Report Date"))
        self.jail_details_check_box.setText(_translate("JailCCPleaDialog", "Jail Details"))
        ...
        self.jail_time_credit_label.setText(_translate("JailCCPleaDialog", "JAIL CREDIT AND REPORTING"))
