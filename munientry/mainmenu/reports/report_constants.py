...
# Reset Case Arraignment (rest) - 361, 491 (491 is reset interpreter)
# GREEN (Arraignment - clerk event code) - 169
ARRAIGNMENT_EVENT_IDS = "('27', '28', '77', '169', '361', '474', '491')"
...
FINAL_PRETRIAL_EVENT_IDS = "('157', '160', '161', '334', '335', '336', '337', '477', '478')"

# Trial to Court A (TCN) - 412, 492
# Trial to Court B (TCNB) - 413, 493
# Trial to Court C (TCNC) - 414, 494
# Trial to Court - 410
TRIAL_TO_COURT_EVENT_IDS = "('410', '412', '413', '414', '492', '493', '494')"

# Plea in A - 292, 486 Plea in B - 293,, 487 Plea in C - 294, 488; Plea - 291
PLEA_EVENT_IDS = "('291', '292', '293', '294', '486', '487', '488')"

# Jury Trial in A - 201, 479 Jury Trial in B - 202, 480, Jury Trial - 200
JURY_TRIAL_EVENT_IDS = "('200', '201', '202', '479', '480')"
