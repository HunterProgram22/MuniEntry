...
class TrialToCourtDialogViewModifier(BaseDialogViewModifier):
    """Class for setting up and modifying the Trial To Court view."""
...
class TrialToCourtDialogSlotFunctions(BaseDialogSlotFunctions):
    """Class containing all Trial To Court functions - currently only inherits from Base."""


class TrialToCourtDialogCaseInformationUpdater(CaseInformationUpdater):
    """Class for updating case information for Trial To Court Dialog."""
